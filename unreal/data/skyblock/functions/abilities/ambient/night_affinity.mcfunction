...
attribute @p[tag=mushroom_armor,predicate=skyblock:time/night] minecraft:generic.max_health modifier add 60-2-51-4-79 "Night Affinity" 22 add
attribute @p[tag=mushroom_armor,predicate=skyblock:time/night] minecraft:generic.armor modifier add 65-49-36-20-48 "Night Affinity" 6 add
tellraw @p[tag=mushroom_armor,predicate=skyblock:time/night] {"text":"[Night Affinity: +22 Max Health, +6 Armor]","italic":true,"color":"gray"}
