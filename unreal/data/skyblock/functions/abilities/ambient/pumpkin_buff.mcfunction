tag @p[advancements={skyblock:commands/abilities/pumpkin_buff=true}] add pumpkin_buff
...
advancement revoke @p[advancements={skyblock:commands/abilities/pumpkin_buff=true},tag=!pumpkin_armor] only skyblock:commands/abilities/pumpkin_buff
