...
attribute @p[predicate=skyblock:wearing_pumpkin_armor] minecraft:generic.attack_damage modifier add 798881313-616402189-469640523-874749491-17616151 "Pumpkin Armor Damage" 0.1 multiply
