tag @p[advancements={skyblock:commands/abilities/deepness_within=true}] add deepness_within
...
advancement revoke @p[advancements={skyblock:commands/abilities/deepness_within=true},tag=!angler_armor] only skyblock:commands/abilities/deepness_within
