...
execute at @e[tag=calc] run execute if entity @p[predicate=skyblock:ender_bow] run summon armor_stand ~ ~ ~ {Invulnerable:true,Tags:["projectile","ender_warp"]}
execute at @e[tag=calc] run execute if entity @p[predicate=skyblock:explosive_bow] run summon armor_stand ~ ~ ~ {Invulnerable:true,Tags:["projectile","explosive_shot"]}
execute at @e[tag=calc] run execute if entity @p[predicate=skyblock:soulstealer_bow_rare] run summon armor_stand ~ ~ ~ {Invulnerable:true,Tags:["projectile","soulstealer_bow"]}
execute at @e[tag=calc] run execute if entity @p[predicate=skyblock:soulstealer_bow_epic] run summon armor_stand ~ ~ ~ {Invulnerable:true,Tags:["projectile","soulstealer_bow"]}
