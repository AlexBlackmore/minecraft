tag @p[advancements={skyblock:commands/abilities/shiny_orb=true}] add shiny_orb
...
advancement revoke @p[tag=shiny_orb] only skyblock:commands/abilities/shiny_orb
