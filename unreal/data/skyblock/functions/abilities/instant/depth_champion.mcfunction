tag @p[advancements={skyblock:commands/abilities/depth_champion=true}] add depth_champion
...
advancement revoke @p[tag=depth_champion] only skyblock:commands/abilities/depth_champion
