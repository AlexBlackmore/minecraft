...
execute if entity @e[tag=success,tag=anvil,scores={random=0},limit=1,sort=nearest] run function skyblock:reforging/reforges/armor/clean
execute if entity @e[tag=success,tag=anvil,scores={random=1},limit=1,sort=nearest] run function skyblock:reforging/reforges/armor/fierce
execute if entity @e[tag=success,tag=anvil,scores={random=2},limit=1,sort=nearest] run function skyblock:reforging/reforges/armor/heavy
execute if entity @e[tag=success,tag=anvil,scores={random=3},limit=1,sort=nearest] run function skyblock:reforging/reforges/armor/light
execute if entity @e[tag=success,tag=anvil,scores={random=4},limit=1,sort=nearest] run function skyblock:reforging/reforges/armor/mythic
execute if entity @e[tag=success,tag=anvil,scores={random=5},limit=1,sort=nearest] run function skyblock:reforging/reforges/armor/pure
execute if entity @e[tag=success,tag=anvil,scores={random=6},limit=1,sort=nearest] run function skyblock:reforging/reforges/armor/smart
execute if entity @e[tag=success,tag=anvil,scores={random=7},limit=1,sort=nearest] run function skyblock:reforging/reforges/armor/titanic
execute if entity @e[tag=success,tag=anvil,scores={random=8},limit=1,sort=nearest] run function skyblock:reforging/reforges/armor/wise
...
advancement revoke @s only skyblock:commands/npcs/blacksmith/armor
