...
execute if entity @e[tag=success,tag=anvil,scores={random=0},limit=1,sort=nearest] run function skyblock:reforging/reforges/swords/gentle
execute if entity @e[tag=success,tag=anvil,scores={random=1},limit=1,sort=nearest] run function skyblock:reforging/reforges/swords/odd
execute if entity @e[tag=success,tag=anvil,scores={random=2},limit=1,sort=nearest] run function skyblock:reforging/reforges/swords/fast
execute if entity @e[tag=success,tag=anvil,scores={random=3},limit=1,sort=nearest] run function skyblock:reforging/reforges/swords/fair
execute if entity @e[tag=success,tag=anvil,scores={random=4},limit=1,sort=nearest] run function skyblock:reforging/reforges/swords/epic
execute if entity @e[tag=success,tag=anvil,scores={random=5},limit=1,sort=nearest] run function skyblock:reforging/reforges/swords/sharp
execute if entity @e[tag=success,tag=anvil,scores={random=6},limit=1,sort=nearest] run function skyblock:reforging/reforges/swords/heroic
execute if entity @e[tag=success,tag=anvil,scores={random=7},limit=1,sort=nearest] run function skyblock:reforging/reforges/swords/spicy
execute if entity @e[tag=success,tag=anvil,scores={random=8},limit=1,sort=nearest] run function skyblock:reforging/reforges/swords/legendary
...
advancement revoke @s only skyblock:commands/npcs/blacksmith/swords
