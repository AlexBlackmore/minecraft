...
scoreboard players set @e[tag=anvil,limit=1,sort=nearest] dummy 4
...
execute if entity @e[tag=success,tag=anvil,scores={random=0},limit=1,sort=nearest] run function skyblock:reforging/reforges/hoes/robust
execute if entity @e[tag=success,tag=anvil,scores={random=1},limit=1,sort=nearest] run function skyblock:reforging/reforges/hoes/zooming
execute if entity @e[tag=success,tag=anvil,scores={random=2},limit=1,sort=nearest] run function skyblock:reforging/reforges/hoes/pleasant
execute if entity @e[tag=success,tag=anvil,scores={random=3},limit=1,sort=nearest] run function skyblock:reforging/reforges/hoes/green_thumb
...
advancement revoke @s only skyblock:commands/npcs/blacksmith/hoes
