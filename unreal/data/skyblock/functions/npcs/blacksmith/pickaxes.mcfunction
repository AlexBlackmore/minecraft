...
scoreboard players set @e[tag=anvil,limit=1,sort=nearest] dummy 5
...
execute if entity @e[tag=success,tag=anvil,scores={random=0},limit=1,sort=nearest] run function skyblock:reforging/reforges/pickaxes/unyielding
execute if entity @e[tag=success,tag=anvil,scores={random=1},limit=1,sort=nearest] run function skyblock:reforging/reforges/pickaxes/prospectors
execute if entity @e[tag=success,tag=anvil,scores={random=2},limit=1,sort=nearest] run function skyblock:reforging/reforges/pickaxes/excellent
execute if entity @e[tag=success,tag=anvil,scores={random=3},limit=1,sort=nearest] run function skyblock:reforging/reforges/pickaxes/sturdy
execute if entity @e[tag=success,tag=anvil,scores={random=4},limit=1,sort=nearest] run function skyblock:reforging/reforges/pickaxes/fortunate
...
advancement revoke @s only skyblock:commands/npcs/blacksmith/pickaxes
