...
execute at @s[predicate=skyblock:is_sneaking] if entity @e[tag=lift_operator,tag=gunpowder_mines,distance=0..4] run function skyblock:teleports/to_lapis_quarry
...
execute at @s[predicate=skyblock:is_sneaking] if entity @e[tag=lift_operator,tag=lapis_quarry,distance=0..4] run function skyblock:teleports/to_pigmens_den
...
execute at @s[predicate=skyblock:is_sneaking] if entity @e[tag=lift_operator,tag=pigmens_den,distance=0..4] run function skyblock:teleports/to_slimehill
...
execute at @s[predicate=skyblock:is_sneaking] if entity @e[tag=lift_operator,tag=slimehill,distance=0..4] run function skyblock:teleports/to_diamond_reserve
...
execute at @s[predicate=skyblock:is_sneaking] if entity @e[tag=lift_operator,tag=diamond_reserve,distance=0..4] run function skyblock:teleports/to_obsidian_sanctuary
...
execute at @s[predicate=skyblock:is_sneaking] if entity @e[tag=lift_operator,tag=obsidian_sanctuary,distance=0..4] run function skyblock:teleports/to_dwarven_mines
