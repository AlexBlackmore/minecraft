tag @p[predicate=skyblock:sneaking,nbt={SelectedItem:{id:"minecraft:fishing_rod"},Inventory:[{Slot:-106b,Count:64b,tag:{Name:"Hunk of Ice"}}]}] add salty
tag @p[predicate=skyblock:sneaking,nbt={SelectedItem:{id:"minecraft:fishing_rod"},Inventory:[{Slot:-106b,Count:64b,tag:{Name:"Hunk of Blue Ice"}}]}] add treacherous
