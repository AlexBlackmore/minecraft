data modify entity @e[tag=anvil,limit=1,sort=nearest] HandItems[0].tag.Reforge set value "Heavy"
...
data modify entity @e[tag=anvil,nbt={HandItems:[{tag:{Reforge:"Heavy",Rarity:0}}]},limit=1,sort=nearest] HandItems[0].tag.ReforgeCritChance set value -1
data modify entity @e[tag=anvil,nbt={HandItems:[{tag:{Reforge:"Heavy",Rarity:1}}]},limit=1,sort=nearest] HandItems[0].tag.ReforgeCritChance set value -2
data modify entity @e[tag=anvil,nbt={HandItems:[{tag:{Reforge:"Heavy",Rarity:2}}]},limit=1,sort=nearest] HandItems[0].tag.ReforgeCritChance set value -2
data modify entity @e[tag=anvil,nbt={HandItems:[{tag:{Reforge:"Heavy",Rarity:3}}]},limit=1,sort=nearest] HandItems[0].tag.ReforgeCritChance set value -3
data modify entity @e[tag=anvil,nbt={HandItems:[{tag:{Reforge:"Heavy",Rarity:4}}]},limit=1,sort=nearest] HandItems[0].tag.ReforgeCritChance set value -5
data modify entity @e[tag=anvil,nbt={HandItems:[{tag:{Reforge:"Heavy",Rarity:5}}]},limit=1,sort=nearest] HandItems[0].tag.ReforgeCritChance set value -7
