...
data modify entity @e[tag=reforge_anvil,limit=1,sort=nearest] HandItems[0].tag.display.color set from entity @s Inventory[{Slot:-106b}].tag.color
data modify entity @e[tag=reforge_anvil,limit=1,sort=nearest] HandItems[0].tag.Dye set from entity @s Inventory[{Slot:-106b}].tag.Dye
data modify entity @e[tag=reforge_anvil,limit=1,sort=nearest] HandItems[0].tag.DyeRarity set from entity @s Inventory[{Slot:-106b}].tag.DyeRarity
