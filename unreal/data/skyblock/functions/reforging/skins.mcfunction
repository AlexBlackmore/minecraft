...
data modify entity @e[tag=anvil,limit=1,sort=nearest] HandItems[0].tag.SkullOwner set from entity @s Inventory[{Slot:-106b}].tag.SkullOwner
data modify entity @e[tag=anvil,limit=1,sort=nearest] HandItems[0].tag.Skin set from entity @s Inventory[{Slot:-106b}].tag.Skin
data modify entity @e[tag=anvil,limit=1,sort=nearest] HandItems[0].tag.SkinRarity set from entity @s Inventory[{Slot:-106b}].tag.SkinRarity
