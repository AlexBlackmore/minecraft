...
#Hoes
execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{Reforge:"Blessed"}}]}] run function skyblock:reforging/reforges/axes/blessed
execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{Reforge:"Bountiful"}}]}] run function skyblock:reforging/reforges/axes/bountiful
...
advancement revoke @s only skyblock:commands/reforging/reforge_stones/hoes
