tag @p[advancements={skyblock:commands/reforging/tools/refined=true}] add reforge
...
execute if entity @p[tag=reforge,scores={rarity=1}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 1.4
execute if entity @p[tag=reforge,scores={rarity=2}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 1.8
execute if entity @p[tag=reforge,scores={rarity=3}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 2.6
execute if entity @p[tag=reforge,scores={rarity=4}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 3.2
...
execute if entity @p[tag=reforge] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.Reforge set value "Refined"
...
execute as @p[tag=reforge,tag=!fail] if @s[nbt={SelecTedItem:{tag:{Name:"Refined Diamond Pickaxe"}}}] run item modify entity @s weapon.mainhand skyblock:reforging/duplicate_prefixes/even_more
execute as @p[tag=reforge,tag=!fail] if @s[nbt={SelecTedItem:{tag:{Name:"Refined Netherite Pickaxe"}}}] run item modify entity @s weapon.mainhand skyblock:reforging/duplicate_prefixes/even_more
...
advancement revoke @p[tag=reforge] only skyblock:commands/reforging/tools/refined
