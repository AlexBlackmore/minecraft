tag @p[advancements={skyblock:commands/reforging/tools/bountiful=true}] add reforge
...
tag @p[tag=reforge,scores={rarity=0},level=..83] add fail
tag @p[tag=reforge,scores={rarity=1},level=..111] add fail
tag @p[tag=reforge,scores={rarity=2},level=..150] add fail
tag @p[tag=reforge,scores={rarity=3},level=..200] add fail
tag @p[tag=reforge,scores={rarity=4},level=..275] add fail
tag @p[tag=reforge,scores={rarity=5..},level=..382] add fail
tellraw @p[tag=fail] ["",{"text":"You don't have enough XP to apply that reforge!","color":"red"}]

tellraw @p[tag=reforge,scores={rarity=0}] ["",{"text":"[Cost: 20,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=1}] ["",{"text":"[Cost: 40,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=2}] ["",{"text":"[Cost: 80,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=3}] ["",{"text":"[Cost: 150,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=4}] ["",{"text":"[Cost: 300,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=5..}] ["",{"text":"[Cost: 600,000 XP]","italic":true,"color":"gray"}]

xp add @p[tag=reforge,tag=!fail,scores={rarity=0}] -20000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=1}] -40000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=2}] -80000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=3}] -150000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=4}] -300000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=5..}] -600000 points
...
execute if entity @p[tag=reforge,scores={rarity=0}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Movement Speed",Operation:0}].Amount set value 0.01
execute if entity @p[tag=reforge,scores={rarity=1}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Movement Speed",Operation:0}].Amount set value 0.02
execute if entity @p[tag=reforge,scores={rarity=2}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Movement Speed",Operation:0}].Amount set value 0.03
execute if entity @p[tag=reforge,scores={rarity=3}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Movement Speed",Operation:0}].Amount set value 0.05
execute if entity @p[tag=reforge,scores={rarity=4}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Movement Speed",Operation:0}].Amount set value 0.07
execute if entity @p[tag=reforge,scores={rarity=5..}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Movement Speed",Operation:0}].Amount set value 0.13

execute if entity @p[tag=reforge] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.Reforge set value "Bountiful"
...
advancement revoke @p[tag=reforge] only skyblock:commands/reforging/tools/bountiful
