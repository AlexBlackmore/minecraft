tag @p[advancements={skyblock:commands/reforging/tools/moil=true}] add reforge
...
tag @p[tag=reforge,scores={rarity=0},level=..26] add fail
tag @p[tag=reforge,scores={rarity=1},level=..48] add fail
tag @p[tag=reforge,scores={rarity=2},level=..63] add fail
tag @p[tag=reforge,scores={rarity=3},level=..74] add fail
tag @p[tag=reforge,scores={rarity=4},level=..122] add fail
tag @p[tag=reforge,scores={rarity=5..},level=..146] add fail
tellraw @p[tag=fail] ["",{"text":"You don't have enough XP to apply that reforge!","color":"red"}]

tellraw @p[tag=reforge,scores={rarity=0}] ["",{"text":"[Cost: 1,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=1}] ["",{"text":"[Cost: 5,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=2}] ["",{"text":"[Cost: 10,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=3}] ["",{"text":"[Cost: 15,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=4}] ["",{"text":"[Cost: 50,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=5..}] ["",{"text":"[Cost: 75,000 XP]","italic":true,"color":"gray"}]

xp add @p[tag=reforge,tag=!fail,scores={rarity=0}] -1000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=1}] -5000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=2}] -10000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=3}] -15000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=4}] -50000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=5..}] -75000 points
...
execute if entity @p[tag=reforge] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.Reforge set value "Moil"
...
advancement revoke @p[tag=reforge] only skyblock:commands/reforging/tools/moil
