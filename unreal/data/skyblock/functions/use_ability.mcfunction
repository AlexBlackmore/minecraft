...
#Legs
execute as @p[tag=ability,nbt={Inventory:[{Slot:101b,tag:{Name:"Stereo Pants"}}]}] run function skyblock:abilities/instant/stereo_pants
...
execute as @p[tag=ability,nbt={SelectedItem:{tag:{Name:"Plumber's Sponge"}}}] run function skyblock:abilities/instant/plumbers_sponge
