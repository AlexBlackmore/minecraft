...
scoreboard objectives add month dummy "Month"
scoreboard objectives add year dummy "Year"

scoreboard objectives add armor dummy "Armor"
scoreboard objectives add armor_toughness dummy "Armor Toughness"
scoreboard objectives add attack_damage dummy "Attack Damage"
scoreboard objectives add attack_knockback dummy "Attack Knockback"
scoreboard objectives add attack_speed dummy "Attack Speed"
#scoreboard objectives add flying_speed dummy "Flying Speed"
#scoreboard objectives add follow_range dummy "Follow Range"
scoreboard objectives add knockback_resistance dummy "Knockback Resistance"
