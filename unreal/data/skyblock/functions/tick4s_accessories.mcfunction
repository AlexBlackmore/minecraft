...
execute as @a[advancements={skyblock:accessories/day_crystal=true},predicate=skyblock:time/day] run attribute @s minecraft:generic.attack_damage modifier add 30-5-45-10-69 "Day Crystal Attack Damage" 1 add
execute as @a[advancements={skyblock:accessories/day_crystal=true},predicate=skyblock:time/day] run attribute @s minecraft:generic.armor modifier add 33-91-94-28-54 "Day Crystal Armor" 1 add
...
execute as @a[advancements={skyblock:accessories/night_crystal=true},predicate=skyblock:time/night] run attribute @s minecraft:generic.attack_damage modifier add 30-5-45-10-69 "Night Crystal Attack Damage" 1 add
execute as @a[advancements={skyblock:accessories/night_crystal=true},predicate=skyblock:time/night] run attribute @s minecraft:generic.armor modifier add 33-91-94-28-54 "Night Crystal Armor" 1 add
