...
execute as @e[tag=anvil,limit=1,sort=nearest] unless data entity @s HandItems[0].tag.CustomEnchantments[{id:"skyblock:growth"}] run data modify entity @s HandItems[0].tag.CustomEnchantments insert 0 value {id:"skyblock:growth",lvl:3}
execute as @e[tag=anvil,limit=1,sort=nearest] if data entity @s HandItems[0].tag.CustomEnchantments[{id:"skyblock:growth"}] run data modify entity @s HandItems[0].tag.CustomEnchantments[{id:"skyblock:growth"}].lvl set value 3
...
tellraw @s[tag=success] ["",{"text":"You enchanted your ","color":"white"},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"},{"text":" with "},{"text":"Growth III","color":"blue"},{"text":"!","color":"white"}]
