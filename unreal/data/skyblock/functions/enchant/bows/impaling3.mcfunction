execute if entity @p@p[nbt={SelectedItem:{tag:{Enchantments:[{id:"impaling"}]}}}] run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/increase_impaling
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/increase_impaling
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/increase_impaling
