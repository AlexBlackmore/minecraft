execute if data entity @p SelectedItem.tag.Blessing run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/blessing/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/blessing/set_nbt
