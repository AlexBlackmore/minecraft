execute if data entity @p SelectedItem.tag.Spiked_Hook run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/spiked_hook/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/spiked_hook/set_nbt
