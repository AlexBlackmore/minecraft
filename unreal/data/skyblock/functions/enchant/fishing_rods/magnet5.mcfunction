execute if data entity @p SelectedItem.tag.Magnet run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/magnet/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/magnet/set_nbt
