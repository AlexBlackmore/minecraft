execute if data entity @p SelectedItem.tag.Angler run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/angler/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/angler/set_nbt
