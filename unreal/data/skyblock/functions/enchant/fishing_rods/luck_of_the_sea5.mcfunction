...
execute as @p[level=30..] store success score @s dummy run enchant @s minecraft:luck_of_the_sea 3
item modify entity @p[level=30..,scores={dummy=1}] weapon.mainhand skyblock:enchantments/increase_luck_of_the_sea
item modify entity @p[level=30..,scores={dummy=1}] weapon.mainhand skyblock:enchantments/increase_luck_of_the_sea
