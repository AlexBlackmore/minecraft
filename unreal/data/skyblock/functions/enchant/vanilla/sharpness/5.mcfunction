...
item modify entity @s[tag=success,scores={dummy=0..3}] weapon.mainhand skyblock:enchantments/increase_sharpness
item modify entity @s[tag=success,scores={dummy=0..4}] weapon.mainhand skyblock:enchantments/increase_sharpness
tellraw @s[tag=success] ["",{"text":"You enchanted your ","color":"white"},{"nbt":"SelectedItem.tag.display.Name","interpret":true,"entity":"@s"},{"text":" with "},{"text":"Sharpness V","color":"gray"},{"text":"!","color":"white"}]
