...
execute as @p[level=30..] store success score @s dummy run enchant @s minecraft:protection 4
item modify entity @p[level=30..,scores={dummy=1}] weapon.mainhand skyblock:enchantments/increase_protection
