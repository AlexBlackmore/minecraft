execute if data entity @p SelectedItem.tag.Scavenger run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/scavenger/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/scavenger/set_nbt
