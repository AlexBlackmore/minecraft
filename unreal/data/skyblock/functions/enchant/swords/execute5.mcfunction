execute if data entity @p SelectedItem.tag.Execute run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/execute/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/execute/set_nbt
