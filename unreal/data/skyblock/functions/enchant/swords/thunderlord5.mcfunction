execute if data entity @p SelectedItem.tag.Thunderlord run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/thunderlord/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/thunderlord/set_nbt
