execute if data entity @p SelectedItem.tag.First_Strike run tag @p add fail

tag @p[level=0..74] add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/first_strike/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/first_strike/set_nbt
xp add @p[tag=success] -75 levels
