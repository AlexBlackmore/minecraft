execute if data entity @p SelectedItem.tag.Critical run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/critical/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/critical/set_nbt
