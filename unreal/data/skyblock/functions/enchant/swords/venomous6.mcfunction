execute if data entity @p SelectedItem.tag.Venomous run tag @p add fail

tag @p[level=0..199] add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/venomous/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/venomous/set_nbt
xp add @p[tag=success] -200 levels
