execute if data entity @p SelectedItem.tag.Cleave run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/cleave/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/cleave/set_nbt
