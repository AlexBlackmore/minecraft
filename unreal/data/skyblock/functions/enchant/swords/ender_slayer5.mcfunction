execute if data entity @p SelectedItem.tag.Ender_Slayer run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/ender_slayer/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/ender_slayer/set_nbt
