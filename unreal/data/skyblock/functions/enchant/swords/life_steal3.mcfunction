execute if data entity @p SelectedItem.tag.Life_Steal run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/life_steal/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/life_steal/set_nbt
