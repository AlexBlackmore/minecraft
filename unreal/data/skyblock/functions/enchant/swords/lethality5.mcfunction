execute if data entity @p SelectedItem.tag.Lethality run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/lethality/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/lethality/set_nbt
