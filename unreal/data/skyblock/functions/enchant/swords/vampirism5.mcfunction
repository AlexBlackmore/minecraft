execute if data entity @p SelectedItem.tag.Vampirism run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/vampirism/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/vampirism/set_nbt
