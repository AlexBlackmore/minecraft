execute if data entity @p SelectedItem.tag.Giant_Killer run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/giant_killer/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/giant_killer/set_nbt
