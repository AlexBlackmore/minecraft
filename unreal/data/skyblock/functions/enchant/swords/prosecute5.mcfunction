execute if data entity @p SelectedItem.tag.Prosecute run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/prosecute/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/prosecute/set_nbt
