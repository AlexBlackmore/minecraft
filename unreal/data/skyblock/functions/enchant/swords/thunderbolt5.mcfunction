execute if data entity @p SelectedItem.tag.Thunderbolt run tag @p add fail
...
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/thunderbolt/set_lore
item modify entity @p[tag=success] weapon.mainhand skyblock:enchantments/thunderbolt/set_nbt
