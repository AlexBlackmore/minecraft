...
attribute @p[predicate=skyblock:wearing_cheap_tuxedo] minecraft:generic.attack_damage modifier add 226890022-109737562-55658036-136484533-962645424 "Cheap Tuxedo Damage" 0.5 multiply_base
