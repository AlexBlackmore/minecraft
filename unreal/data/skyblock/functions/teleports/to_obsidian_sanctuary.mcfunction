...
tellraw @s[tag=teleport] ["",{"text":"Warping to Obsidian Sanctuary...","color":"light_purple","bold":false}]
...
execute in skyblock:deep_caverns run tp @s[tag=teleport] 100215 13 99279 90 0
xp add @s -1 points
xp add @s 1 points
