...
tag @s[advancements={skyblock:travel_scrolls/hub_castle=true}] add teleport

tellraw @s[tag=teleport] ["",{"text":"Teleporting to Hub Castle...","color":"yellow","bold":false}]
...
execute in skyblock:hub_island run tp @s[tag=teleport] -248 130 44 -180 0
xp add @s -1 points
xp add @s 1 points
