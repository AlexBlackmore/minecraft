...
tag @s[advancements={skyblock:travel_scrolls/howling_caves=true}] add teleport

tellraw @s[tag=teleport] ["",{"text":"Teleporting to Howling Caves...","color":"yellow","bold":false}]
