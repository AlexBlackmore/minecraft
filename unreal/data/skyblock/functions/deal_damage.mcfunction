...
execute as @e[tag=target] run scoreboard players operation @s absorption -= @p[tag=attacker] damage
...
execute as @e[tag=target] run data modify entity @s HurtTime set value 10s