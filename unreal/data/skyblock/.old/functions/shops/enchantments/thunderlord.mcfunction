...
execute as @p[tag=enchant] run execute store result score @s item_level run data get entity @s SelectedItem.tag.Thunderlord
execute as @p[tag=enchant] run execute store result score @s book_level run data get entity @s Inventory[{Slot:-106b}].tag.Thunderlord
...
execute as @p[tag=enchant,tag=!fail] run scoreboard players set @s xp_cost 14
...
item modify entity @p[tag=enchant,tag=!fail,scores={item_level=0}] weapon.mainhand skyblock:enchantments/thunderlord/set_lore
item modify entity @p[tag=enchant,tag=!fail,scores={item_level=0}] weapon.mainhand skyblock:enchantments/thunderlord/set_nbt1
item modify entity @p[tag=enchant,tag=!fail,scores={item_level=1}] weapon.mainhand skyblock:enchantments/thunderlord/set_nbt2
item modify entity @p[tag=enchant,tag=!fail,scores={item_level=2}] weapon.mainhand skyblock:enchantments/thunderlord/set_nbt3
item modify entity @p[tag=enchant,tag=!fail,scores={item_level=3}] weapon.mainhand skyblock:enchantments/thunderlord/set_nbt4
item modify entity @p[tag=enchant,tag=!fail,scores={item_level=4}] weapon.mainhand skyblock:enchantments/thunderlord/set_nbt5
item modify entity @p[tag=enchant,tag=!fail,scores={item_level=5}] weapon.mainhand skyblock:enchantments/thunderlord/set_nbt6
item replace entity @p[tag=enchant,tag=!fail] weapon.offhand with air

xp add @p[tag=enchant,tag=!fail,scores={item_level=0}] -14 levels
xp add @p[tag=enchant,tag=!fail,scores={item_level=1}] -28 levels
xp add @p[tag=enchant,tag=!fail,scores={item_level=2}] -42 levels
xp add @p[tag=enchant,tag=!fail,scores={item_level=3}] -56 levels
xp add @p[tag=enchant,tag=!fail,scores={item_level=4}] -70 levels
xp add @p[tag=enchant,tag=!fail,scores={item_level=5}] -84 levels
