...
execute as @a[advancements={skyblock:commands/ambient/brute_force=true}] run execute unless entity @s[nbt={Inventory:[{Slot:103b,tag:{Name:"Warden Helmet"}}]}] run advancement revoke @s only skyblock:commands/ambient/brute_force
...
execute as @a[advancements={skyblock:commands/ambient/guardian_chestplate=true}] run execute unless entity @s[predicate=skyblock:guardian_chestplate] run advancement revoke @p only skyblock:commands/ambient/guardian_chestplate

execute as @a[advancements={skyblock:commands/ambient/obsidian_chestplate=true}] run execute unless entity @s[predicate=skyblock:obsidian_chestplate] run advancement revoke @p only skyblock:commands/ambient/obsidian_chestplate

execute as @a[advancements={skyblock:commands/ambient/mithril_coat=true}] run execute unless entity @s[predicate=skyblock:mithril_coat] run advancement revoke @p only skyblock:commands/ambient/mithril_coat

execute as @a[advancements={skyblock:commands/ambient/farmer_boots=true}] run execute unless entity @s[nbt={Inventory:[{Slot:100b,tag:{Name:"Farmer Boots"}}]}] run execute unless entity @s[nbt={Inventory:[{Slot:100b,tag:{Name:"Rancher's Boots"}}]}] run advancement revoke @p only skyblock:commands/ambient/farmer_boots

execute as @a[advancements={skyblock:commands/ambient/raider_axe=true}] run execute unless entity @s[nbt={Inventory:[{tag:{Name:"Raider Axe"}}]}] run advancement revoke @s only skyblock:commands/ambient/raider_axe

execute as @a[advancements={skyblock:commands/ambient/zombie_hat=true}] run execute unless entity @s[nbt={Inventory:[{Slot:103b,tag:{Name:"Zombie Hat"}}]}] run advancement revoke @s only skyblock:commands/ambient/zombie_hat
