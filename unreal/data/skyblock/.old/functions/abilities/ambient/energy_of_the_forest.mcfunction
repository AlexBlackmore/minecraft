tag @p[advancements={skyblock:commands/ambient/energy_of_the_forest=true}] add energy_of_the_forest
...
advancement revoke @p[advancements={skyblock:commands/ambient/energy_of_the_forest=true},tag=!leaflet_armor] only skyblock:commands/ambient/energy_of_the_forest
