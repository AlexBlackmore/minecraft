tag @p[advancements={skyblock:commands/ambient/night_affinity=true}] add night_affinity
...
advancement revoke @p[advancements={skyblock:commands/ambient/night_affinity=true},tag=!mushroom_armor] only skyblock:commands/ambient/night_affinity
