tag @p[advancements={skyblock:commands/ambient/bonus_speed=true}] add bonus_speed
...
advancement revoke @p[advancements={skyblock:commands/ambient/bonus_speed=true},tag=!full_set] only skyblock:commands/ambient/bonus_speed
