tag @p[advancements={skyblock:commands/ambient/haste=true}] add haste
...
advancement revoke @p[advancements={skyblock:commands/ambient/haste=true},tag=!miners_outfit] only skyblock:commands/ambient/haste
