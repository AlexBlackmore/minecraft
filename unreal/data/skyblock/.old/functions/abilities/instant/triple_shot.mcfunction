...
execute at @p[tag=bow] run summon armor_stand ^-0.2 ^ ^1.8 {Tags:["triple_shot1","motion"]}
execute at @p[tag=bow] run summon armor_stand ^0.2 ^ ^1.8 {Tags:["triple_shot2","motion"]}
...
execute as @e[tag=calc] run execute store result entity @s damage double 0.1 run data get entity @e[tag=shot,limit=1,sort=nearest] damage 0.4
execute store result score @p[tag=bow] damage run data get entity @e[tag=shot,limit=1,sort=nearest] damage 0.4
tellraw @p[tag=bow] ["",{"text":"[Triple Shot: ","italic":true,"color":"gray"},{"score":{"name":"*","objective":"damage"},"italic":true,"color":"gray"},{"text":" damage]","italic":true,"color":"gray"}]
