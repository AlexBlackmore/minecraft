...
execute unless entity @e[tag=teleport] run execute at @p[tag=strong_blood] run execute if block ^ ^ ^10 #skyblock:air run summon armor_stand ^ ^ ^10 {Tags:["teleport"]}
execute at @e[tag=teleport] run execute unless block ~ ~1 ~ #skyblock:air run kill @e[tag=teleport]
execute unless entity @e[tag=teleport] run execute at @p[tag=strong_blood] run execute if block ^ ^ ^9 #skyblock:air run summon armor_stand ^ ^ ^9 {Tags:["teleport"]}
execute at @e[tag=teleport] run execute unless block ~ ~1 ~ #skyblock:air run kill @e[tag=teleport]

execute unless entity @e[tag=teleport] run execute at @p[tag=ability] run execute if block ^ ^ ^8 #skyblock:air run summon armor_stand ^ ^ ^8 {Tags:["teleport"]}
execute at @e[tag=teleport] run execute unless block ~ ~1 ~ #skyblock:air run kill @e[tag=teleport]
execute unless entity @e[tag=teleport] run tellraw @p[tag=ability] {"text":"There are blocks in the way!","color":"red"}
execute unless entity @e[tag=teleport] run execute at @p[tag=ability] run execute if block ^ ^ ^7 #skyblock:air run summon armor_stand ^ ^ ^7 {Tags:["teleport"]}
execute at @e[tag=teleport] run execute unless block ~ ~1 ~ #skyblock:air run kill @e[tag=teleport]
execute unless entity @e[tag=teleport] run execute at @p[tag=ability] run execute if block ^ ^ ^6 #skyblock:air run summon armor_stand ^ ^ ^6 {Tags:["teleport"]}
execute at @e[tag=teleport] run execute unless block ~ ~1 ~ #skyblock:air run kill @e[tag=teleport]
execute unless entity @e[tag=teleport] run execute at @p[tag=ability] run execute if block ^ ^ ^5 #skyblock:air run summon armor_stand ^ ^ ^5 {Tags:["teleport"]}
execute at @e[tag=teleport] run execute unless block ~ ~1 ~ #skyblock:air run kill @e[tag=teleport]
execute unless entity @e[tag=teleport] run execute at @p[tag=ability] run execute if block ^ ^ ^4 #skyblock:air run summon armor_stand ^ ^ ^4 {Tags:["teleport"]}
execute at @e[tag=teleport] run execute unless block ~ ~1 ~ #skyblock:air run kill @e[tag=teleport]
execute unless entity @e[tag=teleport] run execute at @p[tag=ability] run execute if block ^ ^ ^3 #skyblock:air run summon armor_stand ^ ^ ^3 {Tags:["teleport"]}
execute at @e[tag=teleport] run execute unless block ~ ~1 ~ #skyblock:air run kill @e[tag=teleport]
execute unless entity @e[tag=teleport] run execute at @p[tag=ability] run execute if block ^ ^ ^2 #skyblock:air run summon armor_stand ^ ^ ^2 {Tags:["teleport"]}
execute at @e[tag=teleport] run execute unless block ~ ~1 ~ #skyblock:air run kill @e[tag=teleport]
