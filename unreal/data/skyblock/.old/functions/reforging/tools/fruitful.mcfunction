tag @p[advancements={skyblock:commands/reforging/tools/fruitful=true}] add reforge
...
tag @p[tag=reforge,scores={rarity=0},level=..7] add fail
tag @p[tag=reforge,scores={rarity=1},level=..13] add fail
tag @p[tag=reforge,scores={rarity=2},level=..19] add fail
tag @p[tag=reforge,scores={rarity=3},level=..26] add fail
tag @p[tag=reforge,scores={rarity=4},level=..37] add fail
tag @p[tag=reforge,scores={rarity=5..},level=..74] add fail
tellraw @p[tag=fail] ["",{"text":"You don't have enough XP to apply that reforge!","color":"red"}]

tellraw @p[tag=reforge,scores={rarity=0}] ["",{"text":"[Cost: 100 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=1}] ["",{"text":"[Cost: 250 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=2}] ["",{"text":"[Cost: 500 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=3}] ["",{"text":"[Cost: 1,000 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=4}] ["",{"text":"[Cost: 2,500 XP]","italic":true,"color":"gray"}]
tellraw @p[tag=reforge,scores={rarity=5..}] ["",{"text":"[Cost: 15,000 XP]","italic":true,"color":"gray"}]

xp add @p[tag=reforge,tag=!fail,scores={rarity=0}] -100 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=1}] -250 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=2}] -500 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=3}] -1000 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=4}] -2500 points
xp add @p[tag=reforge,tag=!fail,scores={rarity=5..}] -15000 points
...
execute if entity @p[tag=reforge,scores={rarity=0}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 0.6
execute if entity @p[tag=reforge,scores={rarity=1}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 0.8
execute if entity @p[tag=reforge,scores={rarity=2}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 1
execute if entity @p[tag=reforge,scores={rarity=3}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 1.4
execute if entity @p[tag=reforge,scores={rarity=4}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 1.8
execute if entity @p[tag=reforge,scores={rarity=5..}] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.AttributeModifiers[{Name:"Reforge Armor",Operation:0}].Amount set value 2.4

execute if entity @p[tag=reforge] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.Reforge_Intelligence set value 1

execute if entity @p[tag=reforge] as @e[type=armor_stand,tag=reforge] run data modify entity @s HandItems[0].tag.Reforge set value "Fruitful"
...
advancement revoke @p[tag=reforge] only skyblock:commands/reforging/tools/fruitful
