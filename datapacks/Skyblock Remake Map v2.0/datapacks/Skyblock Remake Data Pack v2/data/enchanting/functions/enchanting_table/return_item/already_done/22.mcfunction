...
data modify entity @s Items prepend value {Slot: 22b, id: "minecraft:gray_dye", Count: 1b, tag: {AlreadyDone:1b,SkyblockMenu:1b, display: {Lore:['{"text":"This item has already been","color":"gray","italic":false}','{"text":"enchanted! Use an Anvil to add","color":"gray","italic":false}','{"text":"more enchantments to it!","color":"gray","italic":false}'],Name: '{"text":"Already Enchanted!","color":"red","italic":false}'}}}
#------------------------------------------#