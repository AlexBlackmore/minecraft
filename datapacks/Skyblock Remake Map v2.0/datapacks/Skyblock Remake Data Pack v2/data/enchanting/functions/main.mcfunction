...
execute as @a[tag=Held_Telekinesis] at @s if entity @e[tag=TravelTo,distance=..5] as @e[type=item,distance=..2.5,tag=!Treecapitator] run kill @s
execute as @a[tag=Held_Telekinesis] at @s as @e[type=item,distance=..2.5,tag=!Treecapitator] run data modify entity @s PickupDelay set value 0
#------------------------------------------#