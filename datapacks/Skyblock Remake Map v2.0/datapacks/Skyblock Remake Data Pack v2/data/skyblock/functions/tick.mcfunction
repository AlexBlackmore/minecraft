...
execute if score Pets SkyblockModules matches 1 run function pets:main
...
execute if score Slayers SkyblockModules matches 1 run function slayers:main
execute if score Backpacks SkyblockModules matches 1 run function backpacks:main
execute if score PersonalCompactors SkyblockModules matches 1 run function personal_compactors:main
#------------------BLOCKS------------------#
