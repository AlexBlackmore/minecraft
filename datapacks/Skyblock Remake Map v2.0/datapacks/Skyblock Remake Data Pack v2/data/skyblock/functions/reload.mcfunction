...
scoreboard players set c65 Constant 65
scoreboard players set c75 Constant 75
...
function time:reset
function slayers:reset
function backpacks:reset
function personal_compactors:reset
function reforges:reset
#------------------TEAMS-------------------#
team add nocol
team modify nocol collisionRule never
#----------------MESSAGES------------------#
tellraw @a [{"text":"Skyblock Remake> ","color":"blue","bold":false},{"text":"Data Pack Modules Finished Reloading!","color":"white","bold":false}]
