...
data modify storage blue:reforge Item.tag.Base.Reforge set value "Odd"
execute if data storage blue:reforge Item.tag.Base{Rarity:"COMMON"} run scoreboard players add CritChan ReforgeStats 12
execute if data storage blue:reforge Item.tag.Base{Rarity:"COMMON"} run scoreboard players add CritChan BReforgeStats 12
...
execute if data storage blue:reforge Item.tag.Base{Rarity:"UNCOMMON"} run scoreboard players add CritChan ReforgeStats 15
execute if data storage blue:reforge Item.tag.Base{Rarity:"UNCOMMON"} run scoreboard players add CritChan BReforgeStats 15
...
execute if data storage blue:reforge Item.tag.Base{Rarity:"MYTHIC"} run scoreboard players remove Intel ReforgeStats 75
execute if data storage blue:reforge Item.tag.Base{Rarity:"MYTHIC"} run scoreboard players remove Intel BReforgeStats 75
