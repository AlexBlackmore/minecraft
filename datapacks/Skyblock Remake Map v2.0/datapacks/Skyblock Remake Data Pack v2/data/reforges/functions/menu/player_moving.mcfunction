...
execute unless score @p[distance=..6] OldRot = @p[distance=..6] NewRot run function reforges:menu/return_item/player_items
execute unless score @p[distance=..6] PlayerPosXOld = @p[distance=..6] PlayerPosX run function reforges:menu/return_item/player_items
execute unless score @p[distance=..6] PlayerPosYOld = @p[distance=..6] PlayerPosY run function reforges:menu/return_item/player_items
execute unless score @p[distance=..6] PlayerPosZOld = @p[distance=..6] PlayerPosZ run function reforges:menu/return_item/player_items
