...
execute store result score $CombineBonus Temp run data get entity @s Inventory[{Slot:100b}].tag.Base.AbilDmg
scoreboard players operation @s P_BonusAbilDmg += $CombineBonus Temp
execute store result score $CombineBonus Temp run data get entity @s Inventory[{Slot:100b}].tag.Base.Ferocity
