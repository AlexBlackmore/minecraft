...
execute store result score Temp P_AFerocity run data get storage blue:item CalcStatAccessory.tag.Base.Ferocity
scoreboard players operation @s P_AFerocity += Temp P_AAtkSpeed
...
scoreboard players set Temp P_AFerocity 0
#------------------------------------------#