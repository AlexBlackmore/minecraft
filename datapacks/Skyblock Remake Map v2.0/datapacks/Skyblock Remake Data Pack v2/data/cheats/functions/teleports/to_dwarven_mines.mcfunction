...
tellraw @s ["",{"text":"Teleporting to Dwarven Mines...","color":"yellow","bold":false}]
execute in skyblock:dwarven_mines run tp @s -85.5 200 -123.5 -90 0
function profiling:set_location/dwarven_mines
