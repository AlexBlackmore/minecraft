...
execute if data entity @s Item.tag.Mithril run data modify storage blue:item item.mithril set from entity @s Item.tag.Mithril
execute unless data entity @s Item.tag.Mithril run data remove storage blue:item item.mithril
...
execute if score #length StringLength matches 41 run function items:new_item/give_rarity/length_41
execute if score #length StringLength matches 42 run function items:new_item/give_rarity/length_42
execute if score #length StringLength matches 43 run function items:new_item/give_rarity/length_43
