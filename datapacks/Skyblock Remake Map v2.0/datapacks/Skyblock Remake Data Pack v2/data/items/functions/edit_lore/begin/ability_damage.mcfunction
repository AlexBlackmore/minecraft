...
data modify storage blue:lore_builder InventoryStorage set from entity @s SelectedItem
#------------MAKE COPY OF LORE-------------#
...
execute in minecraft:overworld run loot replace entity @s weapon.mainhand 1 mine 29999977 1 29832 minecraft:diamond_pickaxe{drop_contents:true}
#------------------------------------------#