...
#==========================================#
#------------------PT 1--------------------#
execute unless entity @s[tag=LinePt2] in minecraft:overworld run data modify block 29999978 1 29832 Text1 set value '[{"text":"Execute ","color":"blue","italic":false},{"nbt":"ItemStorage.Base.Enchantments[].execute.level","storage":"blue:lore_builder","color":"blue","italic":false}]'
execute unless entity @s[tag=LinePt2] run tag @s add DontDupe
execute unless entity @s[tag=LinePt2] run tag @s add LinePt2
#------------------PT 2--------------------#
execute if entity @s[tag=LinePt2,tag=!DontDupe] in minecraft:overworld run data modify block 29999978 1 29832 Text1 set value '[{"block":"29999978 1 29832","nbt":"Text1","interpret":true},{"text":", Execute ","color":"blue","italic":false},{"nbt":"ItemStorage.Base.Enchantments[].execute.level","storage":"blue:lore_builder","color":"blue","italic":false}]'
