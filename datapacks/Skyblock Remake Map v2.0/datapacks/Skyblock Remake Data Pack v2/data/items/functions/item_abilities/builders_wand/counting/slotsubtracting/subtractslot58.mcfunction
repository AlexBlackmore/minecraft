...
scoreboard players operation $Build_Count I_BWBlank_Score -= $CountSlot58 I_BWBlank_Score2
execute if score $Build_Count I_BWBlank_Score matches ..-1 run scoreboard players set $Build_Count I_BWBlank_Score 0
scoreboard players operation $CountSlot58 I_BWBlank_Score2 -= $Build_CountTemp I_BWBlank_Score
execute in minecraft:overworld store result block 29999977 1 29832 Items[{Slot:0b}].tag.store[{Slot:21b}].Count int 1 run scoreboard players get $CountSlot58 I_BWBlank_Score2
...
scoreboard players set $CountSlot58 I_BWBlank_Score -1
scoreboard players set $CountSlot58 I_BWBlank_Score2 0
