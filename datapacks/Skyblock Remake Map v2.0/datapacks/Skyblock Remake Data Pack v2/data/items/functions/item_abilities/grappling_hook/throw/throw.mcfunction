...
scoreboard players operation @s[scores={I_GrappleDist=1..}] I_GrappleDist -= c60 Constant
scoreboard players operation @s[scores={I_GrappleDist=1..}] I_GrappleDist -= c5 Constant
scoreboard players operation @s[scores={I_GrappleDist=..-1}] I_GrappleDist += c60 Constant
scoreboard players operation @s[scores={I_GrappleDist=..-1}] I_GrappleDist += c5 Constant
scoreboard players operation @s I_GrappleDist *= c34 Constant
