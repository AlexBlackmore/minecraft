...
#==========================================#
#---------------COMPASS MENU---------------#
execute as @e[tag=NPCMenu] if score @s PlayerID = @p PlayerID run kill @s
...
execute positioned ~ ~0.5 ~ run scoreboard players set @e[type=chest_minecart,tag=NewMenu,tag=NPCMenu,distance=..1,limit=1,sort=nearest] M_CurrentPage 240
execute positioned ~ ~0.5 ~ run scoreboard players set @e[type=chest_minecart,tag=NewMenu,tag=NPCMenu,distance=..1,limit=1,sort=nearest] M_NPCMenuPage 240
execute positioned ~ ~0.5 ~ run scoreboard players set @e[type=chest_minecart,tag=NewMenu,tag=NPCMenu,distance=..1,limit=1,sort=nearest] M_PageDelay 1
