...
scoreboard players operation $Build_Count I_BWBlank_Score -= $CountSlot61 I_BWBlank_Score2
execute if score $Build_Count I_BWBlank_Score matches ..-1 run scoreboard players set $Build_Count I_BWBlank_Score 0
scoreboard players operation $CountSlot61 I_BWBlank_Score2 -= $Build_CountTemp I_BWBlank_Score
execute in minecraft:overworld store result block 29999977 1 29832 Items[{Slot:0b}].tag.store[{Slot:24b}].Count int 1 run scoreboard players get $CountSlot61 I_BWBlank_Score2
...
scoreboard players set $CountSlot61 I_BWBlank_Score -1
scoreboard players set $CountSlot61 I_BWBlank_Score2 0
