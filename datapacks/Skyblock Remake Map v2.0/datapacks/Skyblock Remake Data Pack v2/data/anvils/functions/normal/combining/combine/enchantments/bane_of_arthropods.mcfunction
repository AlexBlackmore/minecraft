...
execute store result score @s Anvil_Item1 run data get storage blue:anvil Items[{Slot:20b}].tag.Base.Enchantments[{bane_of_arthropods:{identifier:1b}}].bane_of_arthropods.level
execute store result score @s Anvil_Item2 run data get storage blue:anvil Items[{Slot:24b}].tag.Base.Enchantments[{bane_of_arthropods:{identifier:1b}}].bane_of_arthropods.level
...
execute unless data storage blue:anvil ResultItem.tag.Base.Enchantments[].bane_of_arthropods unless data storage blue:anvil ResultItem.tag.Base.Enchantments[].sharpness unless data storage blue:anvil ResultItem.tag.Base.Enchantments[].smite run data modify storage blue:anvil ResultItem.tag.Base.Enchantments append value {bane_of_arthropods:{identifier:1b,level:1}}
#--------SET LEVEL TO DECIDED VALUE--------#
execute unless data storage blue:anvil ResultItem.tag.Base.Enchantments[].sharpness unless data storage blue:anvil ResultItem.tag.Base.Enchantments[].smite store result storage blue:anvil ResultItem.tag.Base.Enchantments[{bane_of_arthropods:{identifier:1b}}].bane_of_arthropods.level int 1 run scoreboard players get @s Anvil_Item1
#---------------ADD XP COST----------------#
