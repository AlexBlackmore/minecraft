...
execute store result score $HotPotatoAmount Temp run data get storage blue:anvil ResultItem.tag.Base.HotPotatoApplied
...
scoreboard players add $HotPotatoAmount Temp 1
...
execute if score PotatoBookLimit Setting matches 1 if score $HotPotatoAmount Temp matches 11.. store result score $Damage Temp run data get storage blue:anvil ResultItem.tag.Base.Damage
execute if score PotatoBookLimit Setting matches 1 if score $HotPotatoAmount Temp matches 11.. store result score $Strength Temp run data get storage blue:anvil ResultItem.tag.Base.Strength
execute if score PotatoBookLimit Setting matches 1 if score $HotPotatoAmount Temp matches 11.. store result score $Defense Temp run data get storage blue:anvil ResultItem.tag.Base.Defense
execute if score PotatoBookLimit Setting matches 1 if score $HotPotatoAmount Temp matches 11.. store result score $Health Temp run data get storage blue:anvil ResultItem.tag.Base.Health
execute if score PotatoBookLimit Setting matches 1 if score $HotPotatoAmount Temp matches 11.. run tag @s remove PotatoBookSuccess
execute if score PotatoBookLimit Setting matches 1 if score $HotPotatoAmount Temp matches 11.. run scoreboard players set $HotPotatoAmount Temp 10
#----------APPLY EVERYTHING BACK-----------#
execute store result storage blue:anvil ResultItem.tag.Base.HotPotatoApplied int 1 run scoreboard players get $HotPotatoAmount Temp
