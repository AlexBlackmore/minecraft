...
execute if score @s AddFarming matches 1.. run function pets:exp_system/skills/fishing/wrong_skill
execute if score @s AddMining matches 1.. run function pets:exp_system/skills/fishing/wrong_skill
execute if score @s AddCombat matches 1.. run function pets:exp_system/skills/fishing/wrong_skill
execute if score @s AddForaging matches 1.. run function pets:exp_system/skills/fishing/wrong_skill
execute if score @s AddAlchemy matches 1.. run function pets:exp_system/skills/fishing/wrong_skill2
execute if score @s AddFishing matches 1.. run function pets:exp_system/skills/fishing/right_skill
execute if score @s AddEnchanting matches 1.. run function pets:exp_system/skills/fishing/wrong_skill2
#------------------------------------------#