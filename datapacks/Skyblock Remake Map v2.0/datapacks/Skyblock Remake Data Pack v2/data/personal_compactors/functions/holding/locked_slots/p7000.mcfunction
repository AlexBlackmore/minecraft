execute unless data entity @s Items[{Slot:0b}].tag.LockedSlot run function menu:return_item/0
...
execute unless data entity @s Items[{Slot:20b}].tag.Base.CompactableMaterial run function menu:return_item/20
execute unless data entity @s Items[{Slot:21b}].tag.Base.CompactableMaterial run function menu:return_item/21
execute unless data entity @s Items[{Slot:22b}].tag.Base.CompactableMaterial run function menu:return_item/22
execute unless data entity @s Items[{Slot:23b}].tag.Base.CompactableMaterial run function menu:return_item/23
execute unless data entity @s Items[{Slot:24b}].tag.Base.CompactableMaterial run function menu:return_item/24
...
execute unless data entity @s Items[{Slot:20b}].tag.Base.CompactableMaterial run item replace entity @s container.20 with air
execute unless data entity @s Items[{Slot:21b}].tag.Base.CompactableMaterial run item replace entity @s container.21 with air
execute unless data entity @s Items[{Slot:22b}].tag.Base.CompactableMaterial run item replace entity @s container.22 with air
execute unless data entity @s Items[{Slot:23b}].tag.Base.CompactableMaterial run item replace entity @s container.23 with air
execute unless data entity @s Items[{Slot:24b}].tag.Base.CompactableMaterial run item replace entity @s container.24 with air
...
execute unless data entity @s Items[{Slot:20b}] run item replace entity @s container.20 with lime_stained_glass_pane{LockedSlot:1b,display:{Name:'[{"text":"Auto-Craft Slot #8","color":"green","italic":false}]',Lore:['[{"text":"Put an enchanted item in","italic":false,"color":"gray"}]','[{"text":"this slot to automatically","italic":false,"color":"gray"}]','[{"text":"craft it.","italic":false,"color":"gray"}]']},Base:{CompactableMaterial:0b}}
execute unless data entity @s Items[{Slot:21b}] run item replace entity @s container.21 with lime_stained_glass_pane{LockedSlot:1b,display:{Name:'[{"text":"Auto-Craft Slot #9","color":"green","italic":false}]',Lore:['[{"text":"Put an enchanted item in","italic":false,"color":"gray"}]','[{"text":"this slot to automatically","italic":false,"color":"gray"}]','[{"text":"craft it.","italic":false,"color":"gray"}]']},Base:{CompactableMaterial:0b}}
execute unless data entity @s Items[{Slot:22b}] run item replace entity @s container.22 with lime_stained_glass_pane{LockedSlot:1b,display:{Name:'[{"text":"Auto-Craft Slot #10","color":"green","italic":false}]',Lore:['[{"text":"Put an enchanted item in","italic":false,"color":"gray"}]','[{"text":"this slot to automatically","italic":false,"color":"gray"}]','[{"text":"craft it.","italic":false,"color":"gray"}]']},Base:{CompactableMaterial:0b}}
execute unless data entity @s Items[{Slot:23b}] run item replace entity @s container.23 with lime_stained_glass_pane{LockedSlot:1b,display:{Name:'[{"text":"Auto-Craft Slot #11","color":"green","italic":false}]',Lore:['[{"text":"Put an enchanted item in","italic":false,"color":"gray"}]','[{"text":"this slot to automatically","italic":false,"color":"gray"}]','[{"text":"craft it.","italic":false,"color":"gray"}]']},Base:{CompactableMaterial:0b}}
execute unless data entity @s Items[{Slot:24b}] run item replace entity @s container.24 with lime_stained_glass_pane{LockedSlot:1b,display:{Name:'[{"text":"Auto-Craft Slot #12","color":"green","italic":false}]',Lore:['[{"text":"Put an enchanted item in","italic":false,"color":"gray"}]','[{"text":"this slot to automatically","italic":false,"color":"gray"}]','[{"text":"craft it.","italic":false,"color":"gray"}]']},Base:{CompactableMaterial:0b}}
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:10b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:10b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl1
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:11b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:11b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl2
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:12b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:12b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl3
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:13b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:13b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl4
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:14b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:14b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl5
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:15b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:15b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl6
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:16b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:16b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl7
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:20b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:20b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl8
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:21b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:21b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl9
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:22b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:22b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl10
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:23b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:23b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl11
execute as @e[type=chest_minecart,limit=1,sort=nearest] unless data entity @s {Items:[{Slot:24b,tag:{LockedSlot:1b}}]} unless data entity @s {Items:[{Slot:24b,tag:{PCLoreMod:1b}}]} run function personal_compactors:compact/get_items/modify_lore/7/sl12
