...
execute unless entity @s[tag=SlayerSpawned] run function slayers:mini_bosses/zombie/check
...
execute if score @s S_CQuestEXP >= @s S_ZNeededExp at @s if score @s S_NoLoop matches 0 at @e[tag=DamageDealt,sort=nearest,limit=1] run function slayers:summon/start_animation
