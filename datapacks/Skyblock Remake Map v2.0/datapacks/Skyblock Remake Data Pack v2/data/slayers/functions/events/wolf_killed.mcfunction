...
execute unless entity @s[tag=SlayerSpawned] run function slayers:mini_bosses/wolf/check
...
execute if score @s S_CQuestEXP >= @s S_WNeededExp at @s if score @s S_NoLoop matches 0 at @e[tag=DamageDealt,sort=nearest,limit=1] run function slayers:summon/start_animation
