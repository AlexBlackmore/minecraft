...
execute if score $PlayerCoins Temp >= Tier1Cost S_SInfos run scoreboard players set $Tier1Test Temp 1
execute unless score $PlayerCoins Temp >= Tier1Cost S_SInfos run scoreboard players set $Tier1Test Temp 0

execute if score $PlayerCoins Temp >= Tier2Cost S_SInfos run scoreboard players set $Tier2Test Temp 1
execute unless score $PlayerCoins Temp >= Tier2Cost S_SInfos run scoreboard players set $Tier2Test Temp 0

execute if score $PlayerCoins Temp >= Tier3Cost S_SInfos run scoreboard players set $Tier3Test Temp 1
execute unless score $PlayerCoins Temp >= Tier3Cost S_SInfos run scoreboard players set $Tier3Test Temp 0

execute if score $PlayerCoins Temp >= Tier4Cost S_SInfos run scoreboard players set $Tier4Test Temp 1
execute unless score $PlayerCoins Temp >= Tier4Cost S_SInfos run scoreboard players set $Tier4Test Temp 0