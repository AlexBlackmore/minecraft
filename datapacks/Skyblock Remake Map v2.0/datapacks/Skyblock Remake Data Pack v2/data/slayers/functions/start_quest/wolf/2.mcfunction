...
tellraw @s ["",{"text":"  »","color":"dark_purple","bold":true},{"text":" Slay ","color":"gray"},{"score":{"name":"WolfTier_2","objective": "S_XPToSpawn"},"color":"red"},{"text":" Combat XP","color":"red"},{"text":" worth of Wolves.","color":"gray"}]
...
scoreboard players operation @s S_WNeededExp = WolfTier_2 S_XPToSpawn
