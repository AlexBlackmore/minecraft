...
tellraw @s ["",{"text":"  »","color":"dark_purple","bold":true},{"text":" Slay ","color":"gray"},{"score":{"name":"SpiderTier_2","objective": "S_XPToSpawn"},"color":"red"},{"text":" Combat XP","color":"red"},{"text":" worth of Spiders.","color":"gray"}]
...
scoreboard players operation @s S_SNeededExp = SpiderTier_2 S_XPToSpawn
scoreboard players set @s S_CQuestType 2
scoreboard players set @s S_CQuestTier 2
