...
tellraw @s ["",{"text":"  »","color":"dark_purple","bold":true},{"text":" Slay ","color":"gray"},{"score":{"name":"SpiderTier_4","objective": "S_XPToSpawn"},"color":"red"},{"text":" Combat XP","color":"red"},{"text":" worth of Spiders.","color":"gray"}]
...
scoreboard players operation @s S_SNeededExp = SpiderTier_4 S_XPToSpawn
