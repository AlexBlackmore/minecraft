...
tellraw @s ["",{"text":"  »","color":"dark_purple","bold":true},{"text":" Slay ","color":"gray"},{"score":{"name":"ZombieTier_2","objective": "S_XPToSpawn"},"color":"red"},{"text":" Combat XP","color":"red"},{"text":" worth of Zombies.","color":"gray"}]
...
scoreboard players operation @s S_ZNeededExp = ZombieTier_2 S_XPToSpawn
