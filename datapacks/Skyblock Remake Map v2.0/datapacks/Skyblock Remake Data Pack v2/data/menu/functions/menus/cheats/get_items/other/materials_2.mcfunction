...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/materials/titanium
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/materials/starfall
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/materials/refined/refined_diamond
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/materials/refined/refined_mithril
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/materials/refined/refined_titanium
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_acacia_wood
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_baked_potato
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_birch_wood
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_blaze_powder
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_blaze_rod
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_block_of_coal
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_bone
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_bone_meal
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_bookshelf
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_bread
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_brown_mushroom
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_brown_mushroom_block
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_cactus
