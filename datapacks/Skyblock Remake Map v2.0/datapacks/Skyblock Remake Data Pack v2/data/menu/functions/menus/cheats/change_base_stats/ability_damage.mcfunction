...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 10b, id: "minecraft:iron_block"}]}] run scoreboard players remove @p P_BaseAbilDmg 100
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p P_BaseAbilDmg 10
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p P_BaseAbilDmg 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p P_BaseAbilDmg 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p P_BaseAbilDmg 10
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 16b, id: "minecraft:gold_block"}]}] run scoreboard players add @p P_BaseAbilDmg 100

execute if score @p P_BaseAbilDmg matches ..-1 run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p P_BaseAbilDmg matches ..-1 run scoreboard players set @p P_BaseAbilDmg 0

execute if score @p P_BaseAbilDmg matches 1000000001.. run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p P_BaseAbilDmg matches 1000000001.. run scoreboard players set @p P_BaseAbilDmg 1000000000
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p P_BaseAbilDmg 0
