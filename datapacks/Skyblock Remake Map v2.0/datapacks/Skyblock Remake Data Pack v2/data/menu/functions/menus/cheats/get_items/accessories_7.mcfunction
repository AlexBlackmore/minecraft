...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/accessory/zombie_talisman
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/accessory/candy_relic
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/accessory/bat_person_talisman
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/accessory/bat_person_ring
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/accessory/bat_person_artifact
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/accessory/dante_talisman
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 117
...
loot replace entity @s container.0 loot cheats:menu/get_items/accessories/7
#------------------------------------------#