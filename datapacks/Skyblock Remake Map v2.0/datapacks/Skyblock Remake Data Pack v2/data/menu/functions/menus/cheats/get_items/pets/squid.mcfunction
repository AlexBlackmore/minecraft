...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/squid/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/squid/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/squid/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/squid/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/squid/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/squid/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/squid
#------------------------------------------#