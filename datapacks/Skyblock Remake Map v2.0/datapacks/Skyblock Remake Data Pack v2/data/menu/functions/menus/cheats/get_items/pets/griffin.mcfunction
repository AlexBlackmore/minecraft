...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/griffin/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/griffin/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/griffin/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/griffin/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/griffin/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/griffin/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/griffin
#------------------------------------------#