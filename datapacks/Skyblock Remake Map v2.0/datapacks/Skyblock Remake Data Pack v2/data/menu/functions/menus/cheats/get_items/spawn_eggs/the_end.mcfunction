...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/weak_enderman
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/medium_enderman
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/strong_enderman
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/zealot
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/enderchest_zealot
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/special_zealot
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/obsidian_defender
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/watcher
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/endermite
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/spawn_egg/the_end/endermite_gate
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/spawn_egg/endermite
