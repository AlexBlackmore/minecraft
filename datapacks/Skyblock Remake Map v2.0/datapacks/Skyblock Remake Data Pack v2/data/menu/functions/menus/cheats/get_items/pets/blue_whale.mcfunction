...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/blue_whale/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/blue_whale/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/blue_whale/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/blue_whale/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/blue_whale/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/blue_whale/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/blue_whale
#------------------------------------------#