...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/silverfish/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/silverfish/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/silverfish/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/silverfish/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/silverfish/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/silverfish/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/silverfish
#------------------------------------------#