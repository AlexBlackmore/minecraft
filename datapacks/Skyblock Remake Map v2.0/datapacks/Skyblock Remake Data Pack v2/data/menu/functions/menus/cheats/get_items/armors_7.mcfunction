...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/water_hydra_head
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/werewolf/full
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/wise_dragon/full
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/armor/wither/full
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/armor/young_dragon/full
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/armor/zombie/full
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/zombie_commander/full
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/zombie_hat
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/zombie_heart
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/zombie_knight/full
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/zombie_lord/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/zombie_soldier/full
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/golem_hat
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/armor/rancher_boots
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/armor/sea_lantern_hat
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 356
