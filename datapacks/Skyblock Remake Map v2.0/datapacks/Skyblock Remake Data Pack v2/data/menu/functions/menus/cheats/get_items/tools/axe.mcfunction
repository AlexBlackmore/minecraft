...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/axes/diamond_axe
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/axes/efficient_axe
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/axes/golden_axe
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/axes/iron_axe
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/axes/jungle_axe
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/axes/promising_axe
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/axes/rookie_axe
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/axes/sculptors_axe
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/axes/stone_axe
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/axes/sweet_axe
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/axes/tree_capitator
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/axes/wooden_axe
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 21b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 96
...
loot replace entity @s container.0 loot cheats:menu/get_items/tools/axe/1
#------------------------------------------#