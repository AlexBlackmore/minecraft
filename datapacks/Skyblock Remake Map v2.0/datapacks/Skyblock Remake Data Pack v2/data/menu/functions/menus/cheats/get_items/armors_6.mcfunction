...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/snow_suit/full
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/sorrow/full
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/speedster/full
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/armor/spider_hat
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/armor/spirit_mask
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/armor/sponge/full
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/spooky/full
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/squid_boots
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/squid_hat
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/stereo_pants
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/storm/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/strong_dragon/full
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/super_heavy/full
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/armor/superior_dragon/full
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/armor/tarantula/full
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/armor/unstable_dragon/full
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/armor/vampire_mask
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/armor/warden_helmet
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 107
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 357
...
loot replace entity @s container.0 loot cheats:menu/get_items/armors/6
#------------------------------------------#