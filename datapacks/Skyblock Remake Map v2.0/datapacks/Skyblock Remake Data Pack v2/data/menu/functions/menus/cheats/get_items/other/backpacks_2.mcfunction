...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot backpacks:give/medium/brown
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot backpacks:give/medium/black
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot backpacks:give/medium/blue
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot backpacks:give/medium/cyan
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot backpacks:give/medium/gray
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot backpacks:give/medium/green
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot backpacks:give/medium/light_blue
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot backpacks:give/medium/light_gray
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot backpacks:give/medium/lime
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot backpacks:give/medium/magenta
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot backpacks:give/medium/orange
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot backpacks:give/medium/pink
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot backpacks:give/medium/plain
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot backpacks:give/medium/red
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot backpacks:give/medium/white
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot backpacks:give/medium/yellow
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 290
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 292
...
loot replace entity @s container.0 loot cheats:menu/get_items/other/backpacks/2
#------------------------------------------#