...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 25b, id: "minecraft:arrow"}]}] run function crafting:menu/save_items
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 25b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage -1

execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:barrier"}]}] run function crafting:menu/save_items
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:barrier"}]}] run function menu:close_menu
#---------------INIT MENU------------------#
