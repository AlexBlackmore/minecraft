...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/phoenix/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/phoenix/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/phoenix/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/phoenix/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/phoenix/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/phoenix/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/phoenix
#------------------------------------------#