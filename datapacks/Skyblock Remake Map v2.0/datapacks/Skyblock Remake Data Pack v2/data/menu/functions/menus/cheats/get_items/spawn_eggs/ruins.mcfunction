...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/spawn_egg/ruins/wolf
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/spawn_egg/ruins/old_wolf
...
loot replace entity @s container.0 loot cheats:menu/get_items/spawn_eggs/ruins
#------------------------------------------#