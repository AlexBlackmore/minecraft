...
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/materials/slayers/revenant_flesh
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/materials/slayers/revenant_viscera
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/materials/slayers/tarantula_web
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/materials/slayers/tarantula_silk
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/materials/slayers/wolf_tooth
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/materials/slayers/golden_tooth
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/materials/bejeweled_handle
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/materials/goblin_egg
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/materials/glacite_jewel
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/materials/mithril
