...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/enderman/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/enderman/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/enderman/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/enderman/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/enderman/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/enderman/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/enderman
#------------------------------------------#