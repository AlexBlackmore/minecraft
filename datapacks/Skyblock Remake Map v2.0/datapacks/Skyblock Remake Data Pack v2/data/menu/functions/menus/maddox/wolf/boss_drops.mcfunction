...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 17b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 255
...
loot replace entity @s container.10 loot slayers:menu/slayer_drops/wolf/wolf_tooth
loot replace entity @s container.11 loot slayers:menu/slayer_drops/wolf/hamster_wheel
execute if score @p S_WolfLvl matches 2.. run loot replace entity @s container.12 loot slayers:menu/slayer_drops/wolf/spirit_rune
execute if score @p S_WolfLvl matches 4.. run loot replace entity @s container.13 loot slayers:menu/slayer_drops/wolf/crit_6
execute if score @p S_WolfLvl matches 5.. run loot replace entity @s container.14 loot slayers:menu/slayer_drops/wolf/red_claw_egg
execute if score @p S_WolfLvl matches 6.. run loot replace entity @s container.15 loot slayers:menu/slayer_drops/wolf/couture_rune
execute if score @p S_WolfLvl matches 7.. run loot replace entity @s container.16 loot slayers:menu/slayer_drops/wolf/overflux_capacitor

execute unless score @p S_WolfLvl matches 2.. run loot replace entity @s container.12 loot slayers:menu/slayer_drops/not_revealed/level_2
execute unless score @p S_WolfLvl matches 4.. run loot replace entity @s container.13 loot slayers:menu/slayer_drops/not_revealed/level_4
execute unless score @p S_WolfLvl matches 5.. run loot replace entity @s container.14 loot slayers:menu/slayer_drops/not_revealed/level_5
execute unless score @p S_WolfLvl matches 6.. run loot replace entity @s container.15 loot slayers:menu/slayer_drops/not_revealed/level_6
execute unless score @p S_WolfLvl matches 7.. run loot replace entity @s container.16 loot slayers:menu/slayer_drops/not_revealed/level_7
#------------------------------------------#