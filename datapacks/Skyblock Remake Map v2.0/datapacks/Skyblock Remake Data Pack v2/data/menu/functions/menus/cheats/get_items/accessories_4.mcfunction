...
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/accessory/personal_compactor_7000
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/accessory/piggy_bank
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/accessory/pigs_foot
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/accessory/potato_talisman
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/accessory/potion_affinity_artifact
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/accessory/potion_affinity_ring
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/accessory/potion_affinity_talisman
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/accessory/red_claw_artifact
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/accessory/red_claw_ring
