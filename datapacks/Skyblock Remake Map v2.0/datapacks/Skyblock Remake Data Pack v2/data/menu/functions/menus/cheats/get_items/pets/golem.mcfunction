...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/golem/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/golem/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/golem/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/golem/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/golem/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/golem/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/golem
#------------------------------------------#