...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:0b}] run scoreboard players set @s M_NewPage 301
execute unless data entity @s Items[{Slot:1b}] run scoreboard players set @s M_NewPage 302
execute unless data entity @s Items[{Slot:2b}] run scoreboard players set @s M_NewPage 303
execute unless data entity @s Items[{Slot:3b}] run scoreboard players set @s M_NewPage 304
execute unless data entity @s Items[{Slot:4b}] run scoreboard players set @s M_NewPage 305
execute unless data entity @s Items[{Slot:5b}] run scoreboard players set @s M_NewPage 306
execute unless data entity @s Items[{Slot:6b}] run scoreboard players set @s M_NewPage 307
execute unless data entity @s Items[{Slot:7b}] run scoreboard players set @s M_NewPage 308
execute unless data entity @s Items[{Slot:8b}] run scoreboard players set @s M_NewPage 309
execute unless data entity @s Items[{Slot:9b}] run scoreboard players set @s M_NewPage 310
execute unless data entity @s Items[{Slot:10b}] run scoreboard players set @s M_NewPage 311
execute unless data entity @s Items[{Slot:11b}] run scoreboard players set @s M_NewPage 312
execute unless data entity @s Items[{Slot:12b}] run scoreboard players set @s M_NewPage 313
execute unless data entity @s Items[{Slot:13b}] run scoreboard players set @s M_NewPage 314
execute unless data entity @s Items[{Slot:14b}] run scoreboard players set @s M_NewPage 315
execute unless data entity @s Items[{Slot:15b}] run scoreboard players set @s M_NewPage 316
execute unless data entity @s Items[{Slot:16b}] run scoreboard players set @s M_NewPage 317
execute unless data entity @s Items[{Slot:17b}] run scoreboard players set @s M_NewPage 318
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 298
...
loot replace entity @s container.0 loot cheats:menu/get_items/pets/1
#------------------------------------------#