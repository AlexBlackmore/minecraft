...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/skeleton_horse/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/skeleton_horse/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/skeleton_horse/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/skeleton_horse/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/skeleton_horse/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/skeleton_horse/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/skeleton_horse
#------------------------------------------#