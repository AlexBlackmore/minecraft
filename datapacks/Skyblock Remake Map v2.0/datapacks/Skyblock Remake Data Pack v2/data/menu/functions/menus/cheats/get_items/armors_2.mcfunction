...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/crown_of_greed
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/crystal/full
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/crystallized_heart
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/armor/diamond/full
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/armor/divan/full
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/armor/diver/full
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/elegant_tuxedo/full
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/ember/full
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/ember_ash/full
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/emerald/full
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/ender/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/enderman_mask
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/fairy/full
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/armor/fancy_tuxedo/full
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/armor/farm/full
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/armor/farm_suit/full
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/armor/farmer_boots
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/armor/final_destination/full
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 95
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 105
...
loot replace entity @s container.0 loot cheats:menu/get_items/armors/2
#------------------------------------------#