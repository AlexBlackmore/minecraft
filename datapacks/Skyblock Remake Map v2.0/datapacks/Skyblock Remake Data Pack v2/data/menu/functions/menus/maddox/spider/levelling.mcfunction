...
execute as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.10 loot slayers:menu/rewards/spider/lvl_1
execute if score @p S_SpiderLvl matches 1.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.11 loot slayers:menu/rewards/spider/lvl_2
execute if score @p S_SpiderLvl matches 2.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.12 loot slayers:menu/rewards/spider/lvl_3
execute if score @p S_SpiderLvl matches 3.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.13 loot slayers:menu/rewards/spider/lvl_4
execute if score @p S_SpiderLvl matches 4.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.14 loot slayers:menu/rewards/spider/lvl_5
execute if score @p S_SpiderLvl matches 5.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.15 loot slayers:menu/rewards/spider/lvl_6
execute if score @p S_SpiderLvl matches 6.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.16 loot slayers:menu/rewards/spider/lvl_7

execute unless score @p S_SpiderLvl matches 1.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.11 loot slayers:menu/rewards/not_revealed/spider/level_2
execute unless score @p S_SpiderLvl matches 2.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.12 loot slayers:menu/rewards/not_revealed/spider/level_3
execute unless score @p S_SpiderLvl matches 3.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.13 loot slayers:menu/rewards/not_revealed/spider/level_4
execute unless score @p S_SpiderLvl matches 4.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.14 loot slayers:menu/rewards/not_revealed/spider/level_5
execute unless score @p S_SpiderLvl matches 5.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.15 loot slayers:menu/rewards/not_revealed/spider/level_6
execute unless score @p S_SpiderLvl matches 6.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.16 loot slayers:menu/rewards/not_revealed/spider/level_7
#------------------------------------------#