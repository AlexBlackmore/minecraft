...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_Farming 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_FarmingN 10
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_Farming 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_FarmingN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_Farming 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_FarmingN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_Farming 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_FarmingN 10

execute if score @p S_Farming matches ..-1 run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Farming matches ..-1 run scoreboard players set @p S_FarmingN 1
execute if score @p S_Farming matches ..-1 run scoreboard players set @p S_Farming 0

execute if score @p S_Farming > @p S_MaxFarming run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Farming > @p S_MaxFarming run scoreboard players operation @p S_FarmingN = @p S_MaxFarming
execute if score @p S_Farming > @p S_MaxFarming run scoreboard players add @p S_FarmingN 1
execute if score @p S_Farming > @p S_MaxFarming run scoreboard players operation @p S_Farming = @p S_MaxFarming
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_Farming 0
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_FarmingN 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_FarmingEXP 0

execute as @p run function skills:farming/next_xp
execute as @p run function skills:farming/calc_percentage
#---------------MENU ITEMS-----------------#
...
execute as @p run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.13 loot skills:menu/base/farming
#------------------------------------------#