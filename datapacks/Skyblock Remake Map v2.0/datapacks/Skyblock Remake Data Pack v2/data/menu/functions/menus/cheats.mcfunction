...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:diamond_sword", Count: 1b}]}] run scoreboard players set @s M_NewPage 277
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 17b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 163
