...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/fish_hat
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/flamebreaker/full
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/frozen_blaze/full
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/armor/ghast_head
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/armor/goblin/full
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/armor/golden/full
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/goldor/full
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/golem/full
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/happy_mask
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/hardened_diamond/full
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/heat/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/heavy/full
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/holy_dragon/full
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/armor/iron/full
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/armor/krampus_helmet
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/armor/lantern_helmet
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/armor/lapis/full
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/armor/leaflet/full
