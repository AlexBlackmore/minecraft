...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/unobtainable/anubis
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/unobtainable/armor_of_the_stars
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/unobtainable/boss
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/unobtainable/kindred
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/unobtainable/kloonboat
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/unobtainable/potato_crown
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/unobtainable/sword_of_the_stars
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/unobtainable/sword_of_the_universe
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/unobtainable/the_fast
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/unobtainable/titan_armor
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/special/ancient_elevator
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/special/bat_the_fish
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/special/cluck_the_fish
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/special/creative_mind
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/special/dead_bush_of_love
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/special/flake_the_fish
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/special/french_bread
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/special/game_breaker
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 131
...
loot replace entity @s container.0 loot cheats:menu/get_items/unobtainable/1
#------------------------------------------#