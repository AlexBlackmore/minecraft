...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/fishing_rods/fishing_rod
...
loot replace entity @s container.0 loot cheats:menu/get_items/tools/fishing_rod/1
#------------------------------------------#