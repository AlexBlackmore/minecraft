...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 9b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 250
...
execute if score @p S_ZombieLvl matches 6.. run loot replace entity @s container.10 loot slayers:menu/slayer_drops/zombie/snake_rune
execute if score @p S_ZombieLvl matches 7.. run loot replace entity @s container.11 loot slayers:menu/slayer_drops/zombie/scythe_blade

execute unless score @p S_ZombieLvl matches 6.. run loot replace entity @s container.10 loot slayers:menu/slayer_drops/not_revealed/level_6
execute unless score @p S_ZombieLvl matches 7.. run loot replace entity @s container.11 loot slayers:menu/slayer_drops/not_revealed/level_7
#------------------------------------------#