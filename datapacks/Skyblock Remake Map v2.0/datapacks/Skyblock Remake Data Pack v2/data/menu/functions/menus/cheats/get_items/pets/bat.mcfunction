...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/bat/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/bat/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/bat/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/bat/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/bat/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/bat/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/bat
#------------------------------------------#