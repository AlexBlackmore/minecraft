...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 10b, id: "minecraft:fern"}]}] if entity @p[scores={C_SeedsL=4..}] as @p run function menu:trades/click/fern
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:dead_bush"}]}] if entity @p[scores={C_SeedsL=5..}] as @p run function menu:trades/click/dead_bush
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:tall_grass"}]}] if entity @p[scores={C_SeedsL=6..}] as @p run function menu:trades/click/tall_grass
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 13b, id: "minecraft:water_bucket"}]}] if entity @p[scores={C_TropicalfishL=2..}] as @p run function menu:trades/click/water_bucket
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:lava_bucket"}]}] if entity @p[scores={C_MagmacreamL=6..}] as @p run function menu:trades/click/lava_bucket
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:milk_bucket"}]}] if entity @p[scores={C_LeatherL=2..}] as @p run function menu:trades/click/milk_bucket
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 16b, id: "minecraft:red_sand"}]}] if entity @p[scores={C_SandL=2..}] as @p run function menu:trades/click/red_sand
...
execute if entity @s[scores={M_PageDelay=0}] if entity @p[scores={C_SeedsL=..3}] unless data entity @s Items[{Slot:10b,id:"minecraft:gray_dye"}] as @p run function menu:trades/fail_notunlocked
execute if entity @s[scores={M_PageDelay=0}] if entity @p[scores={C_SeedsL=..4}] unless data entity @s Items[{Slot:11b,id:"minecraft:gray_dye"}] as @p run function menu:trades/fail_notunlocked
execute if entity @s[scores={M_PageDelay=0}] if entity @p[scores={C_SeedsL=..5}] unless data entity @s Items[{Slot:12b,id:"minecraft:gray_dye"}] as @p run function menu:trades/fail_notunlocked
execute if entity @s[scores={M_PageDelay=0}] if entity @p[scores={C_TropicalfishL=..1}] unless data entity @s Items[{Slot:13b,id:"minecraft:gray_dye"}] as @p run function menu:trades/fail_notunlocked
execute if entity @s[scores={M_PageDelay=0}] if entity @p[scores={C_MagmacreamL=..5}] unless data entity @s Items[{Slot:14b,id:"minecraft:gray_dye"}] as @p run function menu:trades/fail_notunlocked
execute if entity @s[scores={M_PageDelay=0}] if entity @p[scores={C_LeatherL=..1}] unless data entity @s Items[{Slot:15b,id:"minecraft:gray_dye"}] as @p run function menu:trades/fail_notunlocked
execute if entity @s[scores={M_PageDelay=0}] if entity @p[scores={C_SandL=..1}] unless data entity @s Items[{Slot:16b,id:"minecraft:gray_dye"}] as @p run function menu:trades/fail_notunlocked
...
execute if entity @s[tag=!EnderMenuChest] at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.10 loot menu:menu/trades/fern
execute if entity @s[tag=!EnderMenuChest] at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.11 loot menu:menu/trades/dead_bush
execute if entity @s[tag=!EnderMenuChest] at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.12 loot menu:menu/trades/tall_grass
execute if entity @s[tag=!EnderMenuChest] at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.13 loot menu:menu/trades/water_bucket
execute if entity @s[tag=!EnderMenuChest] at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.14 loot menu:menu/trades/lava_bucket
execute if entity @s[tag=!EnderMenuChest] at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.15 loot menu:menu/trades/milk_bucket
execute if entity @s[tag=!EnderMenuChest] at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.16 loot menu:menu/trades/red_sand
#------------------------------------------#