...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_Foraging 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_ForagingN 10
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_Foraging 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_ForagingN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_Foraging 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_ForagingN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_Foraging 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_ForagingN 10

execute if score @p S_Foraging matches ..-1 run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Foraging matches ..-1 run scoreboard players set @p S_ForagingN 1
execute if score @p S_Foraging matches ..-1 run scoreboard players set @p S_Foraging 0

execute if score @p S_Foraging > @p S_MaxForaging run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Foraging > @p S_MaxForaging run scoreboard players operation @p S_ForagingN = @p S_MaxForaging
execute if score @p S_Foraging > @p S_MaxForaging run scoreboard players add @p S_ForagingN 1
execute if score @p S_Foraging > @p S_MaxForaging run scoreboard players operation @p S_Foraging = @p S_MaxForaging
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_Foraging 0
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_Foraging 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_ForagingEXP 0

execute as @p run function skills:foraging/next_xp
execute as @p run function skills:foraging/calc_percentage
#---------------MENU ITEMS-----------------#
...
execute as @p run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.13 loot skills:menu/base/foraging
#------------------------------------------#