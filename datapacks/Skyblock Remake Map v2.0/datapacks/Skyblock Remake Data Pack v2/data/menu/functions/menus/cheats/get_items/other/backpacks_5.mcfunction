...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot backpacks:give/jumbo/brown
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot backpacks:give/jumbo/black
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot backpacks:give/jumbo/blue
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot backpacks:give/jumbo/cyan
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot backpacks:give/jumbo/gray
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot backpacks:give/jumbo/green
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot backpacks:give/jumbo/light_blue
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot backpacks:give/jumbo/light_gray
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot backpacks:give/jumbo/lime
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot backpacks:give/jumbo/magenta
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot backpacks:give/jumbo/orange
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot backpacks:give/jumbo/pink
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot backpacks:give/jumbo/plain
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot backpacks:give/jumbo/red
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot backpacks:give/jumbo/white
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot backpacks:give/jumbo/yellow
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot personal_compactors:jumbo_backpack_upgrade
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 293
...
loot replace entity @s container.0 loot cheats:menu/get_items/other/backpacks/5
#------------------------------------------#