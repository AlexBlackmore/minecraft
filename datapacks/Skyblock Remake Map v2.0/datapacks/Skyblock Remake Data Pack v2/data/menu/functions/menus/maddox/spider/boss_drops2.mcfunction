...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 9b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 252
...
execute if score @p S_SpiderLvl matches 7.. run loot replace entity @s container.10 loot slayers:menu/slayer_drops/spider/digested_mosquito

execute unless score @p S_SpiderLvl matches 7.. run loot replace entity @s container.10 loot slayers:menu/slayer_drops/not_revealed/level_7
#------------------------------------------#