...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:0b}] run scoreboard players set @s M_NewPage 355
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 299
...
loot replace entity @s container.0 loot cheats:menu/get_items/pets/4
#------------------------------------------#