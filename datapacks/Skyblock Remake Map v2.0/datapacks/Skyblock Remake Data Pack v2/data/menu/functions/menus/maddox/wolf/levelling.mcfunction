...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 9b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 245
#---------------MENU ITEMS-----------------#
...
execute as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.10 loot slayers:menu/rewards/wolf/lvl_1
execute if score @p S_WolfLvl matches 1.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.11 loot slayers:menu/rewards/wolf/lvl_2
execute if score @p S_WolfLvl matches 2.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.12 loot slayers:menu/rewards/wolf/lvl_3
execute if score @p S_WolfLvl matches 3.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.13 loot slayers:menu/rewards/wolf/lvl_4
execute if score @p S_WolfLvl matches 4.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.14 loot slayers:menu/rewards/wolf/lvl_5
execute if score @p S_WolfLvl matches 5.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.15 loot slayers:menu/rewards/wolf/lvl_6
execute if score @p S_WolfLvl matches 6.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.16 loot slayers:menu/rewards/wolf/lvl_7

execute unless score @p S_WolfLvl matches 1.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.11 loot slayers:menu/rewards/not_revealed/wolf/level_2
execute unless score @p S_WolfLvl matches 2.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.12 loot slayers:menu/rewards/not_revealed/wolf/level_3
execute unless score @p S_WolfLvl matches 3.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.13 loot slayers:menu/rewards/not_revealed/wolf/level_4
execute unless score @p S_WolfLvl matches 4.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.14 loot slayers:menu/rewards/not_revealed/wolf/level_5
execute unless score @p S_WolfLvl matches 5.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.15 loot slayers:menu/rewards/not_revealed/wolf/level_6
execute unless score @p S_WolfLvl matches 6.. as @p run loot replace entity @e[tag=NPCMenu,sort=nearest,limit=1] container.16 loot slayers:menu/rewards/not_revealed/wolf/level_7
#------------------------------------------#