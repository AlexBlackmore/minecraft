...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot personal_compactors:give/personal_compactor_6000
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot personal_compactors:give/personal_compactor_7000
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 99
