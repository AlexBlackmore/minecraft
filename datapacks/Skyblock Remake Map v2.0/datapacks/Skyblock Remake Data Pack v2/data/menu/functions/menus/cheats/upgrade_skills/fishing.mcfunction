...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_Fishing 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_FishingN 10
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_Fishing 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_FishingN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_Fishing 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_FishingN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_Fishing 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_FishingN 10

execute if score @p S_Fishing matches ..-1 run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Fishing matches ..-1 run scoreboard players set @p S_FishingN 1
execute if score @p S_Fishing matches ..-1 run scoreboard players set @p S_Fishing 0

execute if score @p S_Fishing > @p S_MaxFishing run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Fishing > @p S_MaxFishing run scoreboard players operation @p S_FishingN = @p S_MaxFishing
execute if score @p S_Fishing > @p S_MaxFishing run scoreboard players add @p S_FishingN 1
execute if score @p S_Fishing > @p S_MaxFishing run scoreboard players operation @p S_Fishing = @p S_MaxFishing
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_Fishing 0
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_FishingN 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_FishingEXP 0

execute as @p run function skills:fishing/next_xp
execute as @p run function skills:fishing/calc_percentage
#---------------MENU ITEMS-----------------#
...
execute as @p run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.13 loot skills:menu/base/fishing
#------------------------------------------#