...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/other/slayers/beheaded_horror
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/other/slayers/digested_mosquito
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/other/slayers/fly_swatter
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/other/slayers/foul_flesh
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/other/slayers/grizzly_bait
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/other/slayers/hamster_wheel
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/other/slayers/overflux_capacitor
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/other/slayers/red_claw_egg
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/other/slayers/revenant_catalyst
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/other/slayers/scythe_blade
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/other/slayers/spider_catalyst
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/other/slayers/toxic_arrow_poison
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/other/slayers/undead_catalyst
...
loot replace entity @s container.0 loot cheats:menu/get_items/other/slayers_1
#------------------------------------------#