...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/jerry/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/jerry/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/jerry/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/jerry/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/jerry/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/jerry/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/jerry
#------------------------------------------#