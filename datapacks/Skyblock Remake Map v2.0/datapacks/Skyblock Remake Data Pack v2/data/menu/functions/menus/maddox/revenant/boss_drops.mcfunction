...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 17b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 251
...
loot replace entity @s container.10 loot slayers:menu/slayer_drops/zombie/revenant_flesh
loot replace entity @s container.11 loot slayers:menu/slayer_drops/zombie/foul_flesh
execute if score @p S_ZombieLvl matches 2.. run loot replace entity @s container.12 loot slayers:menu/slayer_drops/zombie/pestilence_rune
execute if score @p S_ZombieLvl matches 2.. run loot replace entity @s container.13 loot slayers:menu/slayer_drops/zombie/undead_catalyst
execute if score @p S_ZombieLvl matches 4.. run loot replace entity @s container.14 loot slayers:menu/slayer_drops/zombie/smite_6
execute if score @p S_ZombieLvl matches 5.. run loot replace entity @s container.15 loot slayers:menu/slayer_drops/zombie/beheaded_horror
execute if score @p S_ZombieLvl matches 6.. run loot replace entity @s container.16 loot slayers:menu/slayer_drops/zombie/revenant_catalyst

execute unless score @p S_ZombieLvl matches 2.. run loot replace entity @s container.12 loot slayers:menu/slayer_drops/not_revealed/level_2
execute unless score @p S_ZombieLvl matches 2.. run loot replace entity @s container.13 loot slayers:menu/slayer_drops/not_revealed/level_2
execute unless score @p S_ZombieLvl matches 4.. run loot replace entity @s container.14 loot slayers:menu/slayer_drops/not_revealed/level_4
execute unless score @p S_ZombieLvl matches 5.. run loot replace entity @s container.15 loot slayers:menu/slayer_drops/not_revealed/level_5
execute unless score @p S_ZombieLvl matches 6.. run loot replace entity @s container.16 loot slayers:menu/slayer_drops/not_revealed/level_6
#------------------------------------------#