...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:0b}] run scoreboard players set @s M_NewPage 337
execute unless data entity @s Items[{Slot:1b}] run scoreboard players set @s M_NewPage 338

execute unless data entity @s Items[{Slot:3b}] run scoreboard players set @s M_NewPage 340
execute unless data entity @s Items[{Slot:4b}] run scoreboard players set @s M_NewPage 341
execute unless data entity @s Items[{Slot:5b}] run scoreboard players set @s M_NewPage 342
execute unless data entity @s Items[{Slot:6b}] run scoreboard players set @s M_NewPage 343
execute unless data entity @s Items[{Slot:7b}] run scoreboard players set @s M_NewPage 344
execute unless data entity @s Items[{Slot:8b}] run scoreboard players set @s M_NewPage 345
execute unless data entity @s Items[{Slot:9b}] run scoreboard players set @s M_NewPage 346
execute unless data entity @s Items[{Slot:10b}] run scoreboard players set @s M_NewPage 347
execute unless data entity @s Items[{Slot:11b}] run scoreboard players set @s M_NewPage 348
execute unless data entity @s Items[{Slot:12b}] run scoreboard players set @s M_NewPage 349
execute unless data entity @s Items[{Slot:13b}] run scoreboard players set @s M_NewPage 350
execute unless data entity @s Items[{Slot:14b}] run scoreboard players set @s M_NewPage 351
execute unless data entity @s Items[{Slot:15b}] run scoreboard players set @s M_NewPage 352
execute unless data entity @s Items[{Slot:16b}] run scoreboard players set @s M_NewPage 353
execute unless data entity @s Items[{Slot:17b}] run scoreboard players set @s M_NewPage 354
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 300
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 298
