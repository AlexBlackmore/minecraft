...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_raw_mutton
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_raw_rabbit
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_raw_salmon
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_red_mushroom
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_red_mushroom_block
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_redstone
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_redstone_block
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_redstone_lamp
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_rotten_flesh
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_sand
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_seeds
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_slime_ball
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_slime_block
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_snow_block
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_spider_eye
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_sponge
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_spruce_wood
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_string
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 137
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 233
...
loot replace entity @s container.0 loot cheats:menu/get_items/other/materials/7
#------------------------------------------#