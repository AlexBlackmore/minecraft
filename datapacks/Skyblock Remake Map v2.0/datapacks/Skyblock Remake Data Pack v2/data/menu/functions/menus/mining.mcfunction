...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 10b, id: "minecraft:gray_dye"}]}] at @a[scores={C_CobblestoneS=0},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:no_collection
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:gray_dye"}]}] at @a[scores={C_CoalS=0},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:no_collection
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:gray_dye"}]}] at @a[scores={C_IronS=0},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:no_collection
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 13b, id: "minecraft:gray_dye"}]}] at @a[scores={C_GoldS=0},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:no_collection
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gray_dye"}]}] at @a[scores={C_DiamondS=0},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:no_collection
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gray_dye"}]}] at @a[scores={C_LapisS=0},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:no_collection
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 16b, id: "minecraft:gray_dye"}]}] at @a[scores={C_EmeraldS=0},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:no_collection

execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 10b, id: "minecraft:cobblestone"}]}] at @a[scores={C_CobblestoneS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function collections:menu_scores/mining/cobblestone
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:coal"}]}] at @a[scores={C_CoalS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function collections:menu_scores/mining/coal
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_ingot"}]}] at @a[scores={C_IronS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function collections:menu_scores/mining/iron
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 13b, id: "minecraft:gold_ingot"}]}] at @a[scores={C_GoldS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function collections:menu_scores/mining/gold
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:diamond"}]}] at @a[scores={C_DiamondS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function collections:menu_scores/mining/diamond
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:lapis_lazuli"}]}] at @a[scores={C_LapisS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function collections:menu_scores/mining/lapis
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 16b, id: "minecraft:emerald"}]}] at @a[scores={C_EmeraldS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function collections:menu_scores/mining/emerald

execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 17b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 8
...
execute at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.4 loot collections:menu/header/mining
execute at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.10 loot collections:menu/button/mining/page_1
#------------------------------------------#