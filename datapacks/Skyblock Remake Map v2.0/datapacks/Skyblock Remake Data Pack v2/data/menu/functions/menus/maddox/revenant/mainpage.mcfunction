...
function slayers:calc_comma_values_zombie

execute as @p run function slayers:test_coins_zombie
...
execute store result score $TempExp Temp run scoreboard players operation c100000 Constant /= @p S_ZombieEXPN
execute store result score $TempExp2 Temp run scoreboard players operation $TempExp Temp *= @p S_ZombieEXP
...
scoreboard players operation $NextSlayerLVL Temp = @p S_ZombieLvl
...
execute if score @p S_Combat matches 15.. if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 5b, id: "minecraft:rotten_flesh"}]}] run function menu:menus/maddox/revenant/tier_4_check_coins
execute if score @p S_Combat matches 10.. if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 4b, id: "minecraft:rotten_flesh"}]}] run function menu:menus/maddox/revenant/tier_3_check_coins
execute if score @p S_Combat matches 5.. if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 3b, id: "minecraft:rotten_flesh"}]}] run function menu:menus/maddox/revenant/tier_2_check_coins
execute if score @p S_Combat matches 0.. if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 2b, id: "minecraft:rotten_flesh"}]}] run function menu:menus/maddox/revenant/tier_1_check_coins
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 13b, id: "minecraft:gold_nugget"}]}] run scoreboard players set @s M_NewPage 250
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 10b, id: "minecraft:gold_block"}]}] run scoreboard players set @s M_NewPage 256
...
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @s S_ZHighSlain matches 1.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.2 loot slayers:menu/revenant/tier_1
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @s S_ZHighSlain matches 2.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.3 loot slayers:menu/revenant/tier_2
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @s S_ZHighSlain matches 3.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.4 loot slayers:menu/revenant/tier_3
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @s S_ZHighSlain matches 4.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.5 loot slayers:menu/revenant/tier_4

execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID unless score @s S_ZHighSlain matches 1.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.2 loot slayers:menu/revenant/tier_1_unknown
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID unless score @s S_ZHighSlain matches 1.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.3 loot slayers:menu/revenant/tier_2_slay_bef
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID unless score @s S_ZHighSlain matches 1.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.4 loot slayers:menu/revenant/tier_3_slay_bef
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID unless score @s S_ZHighSlain matches 1.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.5 loot slayers:menu/revenant/tier_4_slay_bef

execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @s S_ZHighSlain matches 1 run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.3 loot slayers:menu/revenant/tier_2_unknown
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @s S_ZHighSlain matches 1 run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.4 loot slayers:menu/revenant/tier_3_slay_bef
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @s S_ZHighSlain matches 1 run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.5 loot slayers:menu/revenant/tier_4_slay_bef


execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @s S_ZHighSlain matches 2 run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.4 loot slayers:menu/revenant/tier_3_unknown
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @s S_ZHighSlain matches 2 run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.5 loot slayers:menu/revenant/tier_4_slay_bef

execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID if score @p S_ZHighSlain matches 3 run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.5 loot slayers:menu/revenant/tier_4_unknown

execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID unless score @s S_Combat matches 5.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.3 loot slayers:menu/revenant/tier_2_combat_xp
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID unless score @s S_Combat matches 10.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.4 loot slayers:menu/revenant/tier_3_combat_xp
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID unless score @s S_Combat matches 15.. run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.5 loot slayers:menu/revenant/tier_4_combat_xp
...
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.10 loot slayers:menu/revenant/rewards
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.13 loot slayers:menu/revenant/boss_drops
execute at @s as @a[tag=Menu,distance=..6] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.16 loot slayers:menu/revenant/recipes
#------------------------------------------#