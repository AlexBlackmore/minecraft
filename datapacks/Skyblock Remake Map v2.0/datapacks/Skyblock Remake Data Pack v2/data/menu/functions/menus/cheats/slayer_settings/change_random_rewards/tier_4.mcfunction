...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:gold_nugget", Count: 1b}]}] run scoreboard players set @s M_NewPage 238
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:experience_bottle", Count: 1b}]}] run scoreboard players set @s M_NewPage 239
