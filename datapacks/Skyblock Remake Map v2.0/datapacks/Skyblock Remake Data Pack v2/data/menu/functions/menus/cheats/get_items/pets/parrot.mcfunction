...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/parrot/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/parrot/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/parrot/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/parrot/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/parrot/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/parrot/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/parrot
#------------------------------------------#