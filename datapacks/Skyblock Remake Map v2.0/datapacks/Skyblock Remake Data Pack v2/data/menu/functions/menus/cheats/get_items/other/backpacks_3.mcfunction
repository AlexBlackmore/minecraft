...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot backpacks:give/large/brown
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot backpacks:give/large/black
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot backpacks:give/large/blue
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot backpacks:give/large/cyan
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot backpacks:give/large/gray
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot backpacks:give/large/green
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot backpacks:give/large/light_blue
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot backpacks:give/large/light_gray
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot backpacks:give/large/lime
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot backpacks:give/large/magenta
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot backpacks:give/large/orange
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot backpacks:give/large/pink
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot backpacks:give/large/plain
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot backpacks:give/large/red
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot backpacks:give/large/white
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot backpacks:give/large/yellow
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 291
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 293
...
loot replace entity @s container.0 loot cheats:menu/get_items/other/backpacks/3
#------------------------------------------#