...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:gold_nugget", Count: 1b}]}] run scoreboard players set @s M_NewPage 235
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:experience_bottle", Count: 1b}]}] run scoreboard players set @s M_NewPage 236
...
loot replace entity @s container.11 loot cheats:menu/settings/change_random_rewards/tier_3/cost
loot replace entity @s container.15 loot cheats:menu/settings/change_random_rewards/tier_3/xpreward
#------------------------------------------#