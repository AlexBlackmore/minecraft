...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 1b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 148
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 2b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 149
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 3b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 150
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 4b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 151
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 5b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 152
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 6b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 153
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 7b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 155
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 10b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 154
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 156
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 157
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 13b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 158
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 165
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 159
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 16b, tag: {SkyblockMenu:1b}}]}] run scoreboard players set @s M_NewPage 289
...
#---------------MENU ITEMS-----------------#
data merge entity @s {Items: [{Slot: 0b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 8b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 9b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 15b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 17b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 18b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 19b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 20b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 21b, id: "minecraft:arrow", Count: 1b, tag: {SkyblockMenu:1b, display: {Lore: ['[{"text":"To Cheats Menu","color":"gray","italic":false}]'], Name: '{"text":"Go Back","color":"green","italic":false}'}}}, {Slot: 22b, id: "minecraft:barrier", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":"Close","color":"red","italic":false}'}}}, {Slot: 23b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 24b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 25b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}, {Slot: 26b, id: "minecraft:red_stained_glass_pane", Count: 1b, tag: {SkyblockMenu:1b, display: {Name: '{"text":" "}'}}}]}
execute as @p run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.1 loot cheats:change_base_stats/list
execute as @p run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.10 loot cheats:change_base_stats/list_2
#------------------------------------------#