...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_Runecrafting 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_RunecraftingN 10
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_Runecrafting 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_RunecraftingN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_Runecrafting 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_RunecraftingN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_Runecrafting 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_RunecraftingN 10

execute if score @p S_Runecrafting matches ..-1 run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Runecrafting matches ..-1 run scoreboard players set @p S_RunecraftingN 1
execute if score @p S_Runecrafting matches ..-1 run scoreboard players set @p S_Runecrafting 0

execute if score @p S_Runecrafting > @p S_MaxRunecraft run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Runecrafting > @p S_MaxRunecraft run scoreboard players operation @p S_RunecraftingN = @p S_MaxRunecraft
execute if score @p S_Runecrafting > @p S_MaxRunecraft run scoreboard players add @p S_RunecraftingN 1
execute if score @p S_Runecrafting > @p S_MaxRunecraft run scoreboard players operation @p S_Runecrafting = @p S_MaxRunecraft
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_Runecrafting 0
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_RunecraftingN 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_RunecraftEXP 0
#---------------MENU ITEMS-----------------#
...
execute as @p run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.13 loot skills:menu/base/runecrafting
#------------------------------------------#