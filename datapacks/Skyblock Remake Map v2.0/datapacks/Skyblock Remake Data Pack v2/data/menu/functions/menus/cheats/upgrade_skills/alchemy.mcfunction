...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_Alchemy 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:iron_ingot"}]}] run scoreboard players remove @p S_AlchemyN 10
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_Alchemy 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:iron_nugget"}]}] run scoreboard players remove @p S_AlchemyN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_Alchemy 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gold_nugget"}]}] run scoreboard players add @p S_AlchemyN 1
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_Alchemy 10
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:gold_ingot"}]}] run scoreboard players add @p S_AlchemyN 10

execute if score @p S_Alchemy matches ..-1 run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Alchemy matches ..-1 run scoreboard players set @p S_AlchemyN 1
execute if score @p S_Alchemy matches ..-1 run scoreboard players set @p S_Alchemy 0

execute if score @p S_Alchemy > @p S_MaxAlchemy run playsound minecraft:entity.villager.no master @p ~ ~ ~ 1 1 1
execute if score @p S_Alchemy > @p S_MaxAlchemy run scoreboard players operation @p S_AlchemyN = @p S_MaxAlchemy
execute if score @p S_Alchemy > @p S_MaxAlchemy run scoreboard players add @p S_AlchemyN 1
execute if score @p S_Alchemy > @p S_MaxAlchemy run scoreboard players operation @p S_Alchemy = @p S_MaxAlchemy
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_Alchemy 0
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_AlchemyN 1
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 23b, id: "minecraft:tnt", Count: 1b}]}] run scoreboard players set @p S_AlchemyEXP 0

execute as @p run function skills:alchemy/next_xp
execute as @p run function skills:alchemy/calc_percentage
#---------------MENU ITEMS-----------------#
...
execute as @p run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.13 loot skills:menu/base/alchemy
#------------------------------------------#