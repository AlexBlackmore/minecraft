...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/rabbit/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/rabbit/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/rabbit/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/rabbit/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/rabbit/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/rabbit/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/rabbit
#------------------------------------------#