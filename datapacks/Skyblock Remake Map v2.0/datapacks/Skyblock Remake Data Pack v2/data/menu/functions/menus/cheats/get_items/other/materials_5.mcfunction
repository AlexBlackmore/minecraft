...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_gunpowder
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_hay_bale
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_ice
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_ink_sac
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_iron
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_iron_block
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_jungle_wood
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_lapis_block
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_lapis_lazuli
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_lava_bucket
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_leather
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_lily_pad
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_magma_cream
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_melon
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_melon_block
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_mithril
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_nether_wart
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_oak_wood
