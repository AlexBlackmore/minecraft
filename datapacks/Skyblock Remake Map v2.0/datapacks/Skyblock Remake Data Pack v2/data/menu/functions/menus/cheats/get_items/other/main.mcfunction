...
execute if entity @s[scores={M_PageDelay=0}] unless data entity @s Items[{Slot:1b}] run scoreboard players set @s M_NewPage 290
execute if entity @s[scores={M_PageDelay=0}] unless data entity @s Items[{Slot:2b}] run scoreboard players set @s M_NewPage 217
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/other/grappling_hook
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/other/summoning_eye
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/other/remnant_of_the_eye
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/other/magical_mushroom_soup
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/other/mystical_mushroom_soup
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/other/maddox_batphone
execute unless data entity @s Items[{Slot:9b}] as @p at @s run function items:item_abilities/builders_wand/give
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/other/wood_singularity
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/other/catalyst
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/other/flycatcher
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/other/scrolls/implosion
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/other/scrolls/wither_shield
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/other/scrolls/shadow_warp
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/other/hot_potato_book
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/other/fuming_potato_book
...
# execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 295
