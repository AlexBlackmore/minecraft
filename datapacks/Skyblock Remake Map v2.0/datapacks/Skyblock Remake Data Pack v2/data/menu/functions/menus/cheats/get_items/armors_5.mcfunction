...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/pumpkin/full
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/rabbit_hat
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/reaper/full
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/armor/reaper_mask
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/armor/revenant/full
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/armor/revived_heart
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/rotten/full
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/salmon/full
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/salmon_hat
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/shadow_assassin/full
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/shark_scale/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/skeleton_grunt/full
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/skeleton_hat
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/armor/skeleton_lord/full
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/armor/skeleton_master/full
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/armor/skeleton_soldier/full
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/armor/skeletor/full
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/armor/slime_hat
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 106
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 356
...
loot replace entity @s container.0 loot cheats:menu/get_items/armors/5
#------------------------------------------#