...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 9b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 254
#---------------MENU ITEMS-----------------#
...
execute if score @p S_WolfLvl matches 7.. run loot replace entity @s container.10 loot slayers:menu/slayer_drops/wolf/grizzly_bait

execute unless score @p S_WolfLvl matches 7.. run loot replace entity @s container.10 loot slayers:menu/slayer_drops/not_revealed/level_7
#------------------------------------------#