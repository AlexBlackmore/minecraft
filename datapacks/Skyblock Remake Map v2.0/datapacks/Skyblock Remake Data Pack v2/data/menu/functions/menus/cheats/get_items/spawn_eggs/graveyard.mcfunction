...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/spawn_egg/graveyard/zombie
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/spawn_egg/graveyard/zombie_villager
...
loot replace entity @s container.0 loot cheats:menu/get_items/spawn_eggs/graveyard
#------------------------------------------#