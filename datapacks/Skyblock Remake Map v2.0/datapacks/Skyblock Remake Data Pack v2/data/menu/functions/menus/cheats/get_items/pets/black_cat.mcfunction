...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/pet/black_cat/common
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/pet/black_cat/uncommon
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/pet/black_cat/rare
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/pet/black_cat/epic
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/pet/black_cat/legendary
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/pet/black_cat/mythic
...
loot replace entity @s container.11 loot cheats:menu/get_items/pets/black_cat
#------------------------------------------#