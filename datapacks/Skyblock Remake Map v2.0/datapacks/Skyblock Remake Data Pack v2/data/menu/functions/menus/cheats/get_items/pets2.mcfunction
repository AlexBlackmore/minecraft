...
#==========================================#
#-----------------BUTTONS------------------#
execute unless data entity @s Items[{Slot:0b}] run scoreboard players set @s M_NewPage 319
execute unless data entity @s Items[{Slot:1b}] run scoreboard players set @s M_NewPage 320

execute unless data entity @s Items[{Slot:3b}] run scoreboard players set @s M_NewPage 322
execute unless data entity @s Items[{Slot:4b}] run scoreboard players set @s M_NewPage 323
execute unless data entity @s Items[{Slot:5b}] run scoreboard players set @s M_NewPage 324
execute unless data entity @s Items[{Slot:6b}] run scoreboard players set @s M_NewPage 325
execute unless data entity @s Items[{Slot:7b}] run scoreboard players set @s M_NewPage 326
execute unless data entity @s Items[{Slot:8b}] run scoreboard players set @s M_NewPage 327
execute unless data entity @s Items[{Slot:9b}] run scoreboard players set @s M_NewPage 328
execute unless data entity @s Items[{Slot:10b}] run scoreboard players set @s M_NewPage 329
execute unless data entity @s Items[{Slot:11b}] run scoreboard players set @s M_NewPage 330
execute unless data entity @s Items[{Slot:12b}] run scoreboard players set @s M_NewPage 331
execute unless data entity @s Items[{Slot:13b}] run scoreboard players set @s M_NewPage 332
execute unless data entity @s Items[{Slot:14b}] run scoreboard players set @s M_NewPage 333
execute unless data entity @s Items[{Slot:15b}] run scoreboard players set @s M_NewPage 334
execute unless data entity @s Items[{Slot:16b}] run scoreboard players set @s M_NewPage 335
execute unless data entity @s Items[{Slot:17b}] run scoreboard players set @s M_NewPage 336
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 299
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 97
...
loot replace entity @s container.0 loot cheats:menu/get_items/pets/2
#------------------------------------------#