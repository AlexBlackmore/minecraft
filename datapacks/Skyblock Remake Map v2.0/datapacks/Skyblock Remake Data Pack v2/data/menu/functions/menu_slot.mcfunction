...
item replace entity @s[team=!] hotbar.8 with minecraft:nether_star{SkyblockMenu:1b, HideFlags: 63, display: {Lore: ['{"text":"View all your SkyBlock","color":"gray","italic":false}', '{"text":"progress, including your Skills,","color":"gray","italic":false}', '{"text":"Collections, Recipes, and more!","color":"gray","italic":false}', '{"text":" "}', '{"text":"Click to open!","color":"yellow","italic":false}'], Name: '{"text":"SkyBlock Menu","color":"green","italic":false}'}}
item replace entity @s[team=] hotbar.8 with minecraft:nether_star{SkyblockMenu:1b, HideFlags: 63, display: {Lore: ['{"text":"View all available","color":"gray","italic":false}', '{"text":"islands to join!","color":"gray","italic":false}', '{"text":" "}', '{"text":"Click to open!","color":"yellow","italic":false}'], Name: '{"text":"Select Team","color":"red","italic":false}'}}
