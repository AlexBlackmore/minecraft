...
execute positioned ~ ~0.5 ~ run scoreboard players operation @e[type=chest_minecart,tag=NewMenu,distance=..1,limit=1,sort=nearest] M_CurrentPage = @e[tag=NPCName,sort=nearest,limit=1] M_NPCMenuPage
execute positioned ~ ~0.5 ~ run scoreboard players operation @e[type=chest_minecart,tag=NewMenu,distance=..1,limit=1,sort=nearest] M_NPCMenuPage = @e[tag=NPCName,sort=nearest,limit=1] M_NPCMenuPage
