...
execute anchored eyes run summon minecraft:spider ~ ~ ~ {DeathLootTable:"mobs:mob_loot/mini_bosses/vermin",Tags:["MiniBoss","TarantulaVermin"],PortalCooldown:110,CustomName:'[{"text":"Tarantula Vermin"}]',Health:54000,ArmorDropChances:[0.00F,0.00F,0.00F,0.00F],Attributes:[{Name:"generic.attack_damage",Base:900.0F},{Name:"generic.movement_speed",Base:0.5F},{Name:"generic.max_health",Base:54000F}]}
