...
summon minecraft:spider ~ ~ ~ {Tags:["TarantulaBroodfather","Slayer","Tier1","NewSlayer"],CustomName:'[{"text":"Tarantula Broodfather"}]',DeathLootTable:"mobs:mob_loot/slayers/spider/tier_1",Health:500,Attributes:[{Name:"generic.attack_damage",Base:15.0F},{Name:"generic.movement_speed",Base:0.3F},{Name:"generic.max_health",Base:500F}]}
