...
execute anchored eyes run summon minecraft:wolf ~ ~ ~ {DeathLootTable:"mobs:mob_loot/mini_bosses/alpha",AngerTime:99999999,Tags:["MiniBoss","SvenAlpha"],PortalCooldown:340,CustomName:'[{"text":"Sven Alpha"}]',Health:480000,ArmorDropChances:[0.00F,0.00F,0.00F,0.00F],Attributes:[{Name:"generic.attack_damage",Base:5000.0F},{Name:"generic.movement_speed",Base:0.5F},{Name:"generic.max_health",Base:480000F}]}
