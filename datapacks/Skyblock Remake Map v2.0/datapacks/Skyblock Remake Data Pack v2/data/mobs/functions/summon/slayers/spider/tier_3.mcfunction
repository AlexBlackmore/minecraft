...
summon minecraft:spider ~ ~ ~ {Tags:["TarantulaBroodfather","Slayer","Tier3","NewSlayer"],DeathLootTable:"mobs:mob_loot/slayers/spider/tier_3",CustomName:'[{"text":"Tarantula Broodfather"}]',Health:500,Attributes:[{Name:"generic.attack_damage",Base:15.0F},{Name:"generic.movement_speed",Base:0.3F},{Name:"generic.max_health",Base:500F}]}
