...
execute if score out RandMath matches ..20 run function mobs:rare_drops/success/revenant/tier_2/foul_flesh
...
advancement revoke @s only mobs:rare_drops/revenant_tier_2
#------------------------------------------#