...
function stats:calculate/drop_chance/success
execute if score out RandMath <= @s DropChance if score @s S_SpiderLvl matches 6.. run function mobs:rare_drops/success/tarantula/digested_mosquito

advancement revoke @s only mobs:rare_drops/tarantula_tier_4
#------------------------------------------#