...
execute if score ItemCount CraftFilledSlots matches 9.. run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "COUNT_9+"
...
execute if score ItemCount CraftFilledSlots matches 17.. run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "COUNT_17+"
execute if score ItemCount CraftFilledSlots matches 18.. run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "COUNT_18+"
execute if score ItemCount CraftFilledSlots matches 20.. run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "COUNT_20+"
...
execute if score ItemCount CraftFilledSlots matches 39.. run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "COUNT_39+"
...
#---------------WOOD TAG-----------------#
execute if data storage blue:crafting Recipes[{RecipeData:[{Slot:0b,id:"minecraft:oak_log"}]}] run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "LOGS"
execute if data storage blue:crafting Recipes[{RecipeData:[{Slot:0b,id:"minecraft:spruce_log"}]}] run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "LOGS"
execute if data storage blue:crafting Recipes[{RecipeData:[{Slot:0b,id:"minecraft:birch_log"}]}] run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "LOGS"
execute if data storage blue:crafting Recipes[{RecipeData:[{Slot:0b,id:"minecraft:jungle_log"}]}] run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "LOGS"
execute if data storage blue:crafting Recipes[{RecipeData:[{Slot:0b,id:"minecraft:acacia_log"}]}] run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "LOGS"
execute if data storage blue:crafting Recipes[{RecipeData:[{Slot:0b,id:"minecraft:dark_oak_log"}]}] run data modify storage blue:crafting Recipes[0].RecipeData[0].tag.RecipeTags append value "LOGS"
#---------------PLANKS TAG-----------------#
