...
execute if score ItemCount CraftFilledSlots matches 9.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_9+"
...
execute if score ItemCount CraftFilledSlots matches 17.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_17+"
execute if score ItemCount CraftFilledSlots matches 18.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_18+"
execute if score ItemCount CraftFilledSlots matches 20.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_20+"
...
execute if score ItemCount CraftFilledSlots matches 39.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_39+"
