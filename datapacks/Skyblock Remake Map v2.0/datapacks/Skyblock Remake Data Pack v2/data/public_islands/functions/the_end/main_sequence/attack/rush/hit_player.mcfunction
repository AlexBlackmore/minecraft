...
#--------------ATTACK MESSAGE--------------#
tellraw @s ["",{"text":"☬ ","color":"dark_purple"},{"selector":"@e[type=ender_dragon,name=!\"Ender Dragon\",limit=1]"},{"text":" used ","color":"light_purple"},{"text":"Rush","color":"yellow"},{"text":" on you for ","color":"light_purple"},{"score":{"name":"$Damage","objective":"Temp"},"color":"red"},{"text":" damage.","color":"red"}]
