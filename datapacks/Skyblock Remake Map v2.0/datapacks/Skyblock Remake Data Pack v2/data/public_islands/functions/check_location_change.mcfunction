...
execute if entity @s[scores={Location=9}] run function public_islands:location_list_dwarven_mines
execute unless entity @s[scores={Location=9}] run function public_islands:location_list
