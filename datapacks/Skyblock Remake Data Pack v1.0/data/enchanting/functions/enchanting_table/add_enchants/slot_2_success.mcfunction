...
data modify entity @s Items[{Slot:13b}].tag.Base.Enchantments set from entity @s Items[{Slot:0b}].tag.EnchantData[1]
function items:edit_lore/begin/equipment
playsound minecraft:block.enchantment_table.use block @p
scoreboard players operation @p E_XPLevel = @s E_MidSlot
