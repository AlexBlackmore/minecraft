...
#==========================================#
#---------------FOLLOW RANGE---------------#
execute as @e[tag=NaturallySpawning,tag=DisabledRange] at @s as @p if score @s SubLocation = @e[tag=NaturallySpawning,sort=nearest,limit=1] SubLocation run function mobs:naturally_spawning/enable_range
execute as @e[tag=NaturallySpawning,tag=!DisabledRange] at @s as @p unless score @s SubLocation = @e[tag=NaturallySpawning,sort=nearest,limit=1] SubLocation run function mobs:naturally_spawning/disable_range
#------------------MOB AIS-----------------#
