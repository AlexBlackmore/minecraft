...
execute if score @s P_MaxDefense matches 1.. if score @s P_MaxDefense < @s P_Defense run tellraw @s [{"text":"NOTE: ","color":"aqua"},{"text":"Currently the remake has a max of ","color":"white"},{"text":"21,000,000 EHP","color":"green"},{"text":". \n > Your ","color":"white"},{"text":"Defense","color":"green"},{"text":" is temporarily reduced to account for this.","color":"white"},{"text":"\nThis limit will be increased in a later version.","color":"gray","italic":true}]
#------------------------------------------#