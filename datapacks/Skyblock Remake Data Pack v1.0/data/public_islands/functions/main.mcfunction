...
execute as @a[scores={Location=1..}] at @s as @e[type=minecraft:item_frame,distance=..6] at @s run summon minecraft:falling_block ~ ~-0.5 ~ {BlockState:{Name:"minecraft:barrier"}}
#------------------------------------------#