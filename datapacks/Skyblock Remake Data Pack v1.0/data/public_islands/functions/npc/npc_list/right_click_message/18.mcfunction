...
team leave @s
execute positioned ~ ~-2 ~ if entity @e[type=area_effect_cloud,tag=text1,distance=..0.1] run tellraw @s [{"text":"[NPC] Farmer","color":"yellow"},{"text":": Great day to be on the Farm!","color":"white"}]
execute positioned ~ ~-2 ~ if entity @e[type=area_effect_cloud,tag=text2,distance=..0.1] run tellraw @s [{"text":"[NPC] Farmer","color":"yellow"},{"text":": A farmer's life is a simple life.","color":"white"}]
execute positioned ~ ~-2 ~ if entity @e[type=area_effect_cloud,tag=text3,distance=..0.1] run tellraw @s ["",{"text":"[NPC] Farmer","color":"yellow"},{"text":": Howdy, ","color":"white"},{"selector":"@s","color":"white"},{"text":"!","color":"white"}]
