...
execute if score @p AccessoryBagLvl matches ..1 run replaceitem entity @s container.1 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..2 run replaceitem entity @s container.2 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..3 run replaceitem entity @s container.3 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..4 run replaceitem entity @s container.4 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..5 run replaceitem entity @s container.5 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..6 run replaceitem entity @s container.6 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..7 run replaceitem entity @s container.7 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..8 run replaceitem entity @s container.8 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..9 run replaceitem entity @s container.9 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..10 run replaceitem entity @s container.10 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..11 run replaceitem entity @s container.11 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..12 run replaceitem entity @s container.12 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..13 run replaceitem entity @s container.13 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..14 run replaceitem entity @s container.14 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..15 run replaceitem entity @s container.15 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..16 run replaceitem entity @s container.16 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
execute if score @p AccessoryBagLvl matches ..17 run replaceitem entity @s container.17 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
replaceitem entity @s container.18 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
replaceitem entity @s container.19 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
replaceitem entity @s container.20 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
replaceitem entity @s container.21 minecraft:arrow{SkyblockMenu:1b, display: {Name: '{"text":"Go Back","color":"green","italic":false}'}}
replaceitem entity @s container.22 minecraft:barrier{SkyblockMenu:1b, display: {Name: '{"text":"Close","color":"red","italic":false}'}}
replaceitem entity @s container.23 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
replaceitem entity @s container.24 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
replaceitem entity @s container.25 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
replaceitem entity @s container.26 minecraft:black_stained_glass_pane{SkyblockMenu:1b, display: {Name: '{"text":" "}'}}
#------------------------------------------#