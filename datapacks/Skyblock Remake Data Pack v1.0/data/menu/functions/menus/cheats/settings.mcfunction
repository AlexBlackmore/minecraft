...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 8b, tag: {SkyblockMenu:1b}}]}] run function cheats:settings/auto_fairy_soul_stats
...
execute if score AutoFairySoulStats Setting matches 0 run loot replace entity @s container.8 loot cheats:menu/settings/auto_fairy_soul_stats_disabled
execute if score AutoFairySoulStats Setting matches 1 run loot replace entity @s container.8 loot cheats:menu/settings/auto_fairy_soul_stats_enabled
