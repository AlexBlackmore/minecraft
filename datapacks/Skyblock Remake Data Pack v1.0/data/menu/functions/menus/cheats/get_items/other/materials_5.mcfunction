...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_nether_wart
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_oak_wood
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_obsidian
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_packed_ice
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_paper
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_poisonous_potato
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_poppy
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_pork
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_potato
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_prismarine_crystals
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_prismarine_shard
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_pufferfish
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_pumpkin
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_quartz
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_quartz_block
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_rabbit_foot
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_rabbit_hide
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_raw_beef
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 135
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 137
...
loot replace entity @s container.0 loot cheats:menu/get_items/other/materials/5
#------------------------------------------#