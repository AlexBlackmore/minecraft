...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/holy_dragon/full
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/iron/full
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/krampus_helmet
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/armor/lantern_helmet
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/armor/lapis/full
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/armor/leaflet/full
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/leather/full
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/magma_cube_head
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/mastiff/full
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/miner/full
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/miner_outfit/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/mineral/full
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/monster_hunter/full
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/armor/mushroom/full
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/armor/obsidian_chestplate
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/armor/old_dragon/full
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/armor/perfect/full
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/armor/protector_dragon/full
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 104
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 106
...
loot replace entity @s container.0 loot cheats:menu/get_items/armors/3
#------------------------------------------#