...
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/other/grappling_hook
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/other/summoning_eye
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/other/remnant_of_the_eye
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/other/magical_mushroom_soup
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/other/mystical_mushroom_soup
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/other/catalyst
