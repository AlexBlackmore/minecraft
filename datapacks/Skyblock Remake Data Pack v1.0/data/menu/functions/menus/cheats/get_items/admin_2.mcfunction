...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/special/gift_the_fish
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/special/golden_gift
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/special/nope_the_fish
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/special/oops_the_fish
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/special/quality_map
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/special/shrimp_the_fish
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 101
...
loot replace entity @s container.0 loot cheats:menu/get_items/unobtainable/2
#------------------------------------------#