...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/stereo_pants
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/strong_dragon/full
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/superior_dragon/full
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/armor/tarantula/full
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/armor/unstable_dragon/full
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/armor/vampire_mask
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/water_hydra_head
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/werewolf/full
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/wise_dragon/full
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/young_dragon/full
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/zombie/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/zombie_hat
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/zombie_heart
