...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/materials/crystal_fragment
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/materials/dragon_fragment/old
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/materials/dragon_fragment/protector
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/materials/dragon_fragment/strong
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/materials/dragon_fragment/superior
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/materials/dragon_fragment/unstable
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/materials/dragon_fragment/wise
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/materials/dragon_fragment/young
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_acacia_wood
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_baked_potato
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_birch_wood
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_blaze_powder
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_blaze_rod
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_block_of_coal
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_bone
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_bone_meal
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_bookshelf
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/materials/enchanted/enchanted_bread
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 133
