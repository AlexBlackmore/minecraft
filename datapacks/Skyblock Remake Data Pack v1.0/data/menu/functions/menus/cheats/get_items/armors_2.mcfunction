...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/diamond/full
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/diver/full
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/elegant_tuxedo/full
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/armor/ember/full
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/armor/emerald/full
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/armor/ender/full
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/enderman_mask
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/fairy/full
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/fancy_tuxedo/full
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/farm/full
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/farm_suit/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/farmer_boots
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/fish_hat
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/armor/frozen_blaze/full
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/armor/ghast_head
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/armor/golden/full
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/armor/golem/full
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/armor/hardened_diamond/full
