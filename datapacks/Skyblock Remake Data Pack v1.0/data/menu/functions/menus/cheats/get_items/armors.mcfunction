...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/angler/full
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/armor_of_growth/full
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/armor_of_magma/full
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/armor/armor_of_the_pack/full
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/armor/bat_person/full
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/armor/blaze/full
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/blaze_hat
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/blobfish_hat
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/cactus/full
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/chainmail/full
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/cheap_tuxedo/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/chicken_head
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/clownfish_hat
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/armor/cow_head
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/armor/creeper_hat
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/armor/crown_of_greed
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/armor/crystal/full
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/armor/crystallized_heart
