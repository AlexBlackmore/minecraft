...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/accessory/fish_affinity_talisman
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/accessory/frozen_chicken
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/accessory/gravity_talisman
execute unless data entity @s Items[{Slot:3b}] run loot give @p loot cheats:get_items/accessory/haste_ring
execute unless data entity @s Items[{Slot:4b}] run loot give @p loot cheats:get_items/accessory/healing_ring
execute unless data entity @s Items[{Slot:5b}] run loot give @p loot cheats:get_items/accessory/healing_talisman
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/accessory/hunter_ring
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/accessory/hunter_talisman
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/accessory/intimidation_artifact
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/accessory/intimidation_ring
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/accessory/intimidation_talisman
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/accessory/invaluable_ring_of_love
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/accessory/lava_talisman
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/accessory/legendary_ring_of_love
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/accessory/lynx_talisman
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/accessory/magnetic_talisman
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/accessory/mediocre_ring_of_love
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/accessory/melodys_hair
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 18b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 113
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 26b, id: "minecraft:arrow"}]}] run scoreboard players set @s M_NewPage 115
...
loot replace entity @s container.0 loot cheats:menu/get_items/accessories/3
#------------------------------------------#