...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/armor/pufferfish_hat
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/armor/pumpkin/full
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/armor/rabbit_hat
...
execute unless data entity @s Items[{Slot:6b}] run loot give @p loot cheats:get_items/armor/salmon_hat
execute unless data entity @s Items[{Slot:7b}] run loot give @p loot cheats:get_items/armor/shark_scale/full
execute unless data entity @s Items[{Slot:8b}] run loot give @p loot cheats:get_items/armor/skeleton_hat
execute unless data entity @s Items[{Slot:9b}] run loot give @p loot cheats:get_items/armor/slime_hat
execute unless data entity @s Items[{Slot:10b}] run loot give @p loot cheats:get_items/armor/snow_suit/full
execute unless data entity @s Items[{Slot:11b}] run loot give @p loot cheats:get_items/armor/speedster/full
execute unless data entity @s Items[{Slot:12b}] run loot give @p loot cheats:get_items/armor/spider_hat
execute unless data entity @s Items[{Slot:13b}] run loot give @p loot cheats:get_items/armor/spirit_mask
execute unless data entity @s Items[{Slot:14b}] run loot give @p loot cheats:get_items/armor/sponge/full
execute unless data entity @s Items[{Slot:15b}] run loot give @p loot cheats:get_items/armor/spooky/full
execute unless data entity @s Items[{Slot:16b}] run loot give @p loot cheats:get_items/armor/squid_boots
execute unless data entity @s Items[{Slot:17b}] run loot give @p loot cheats:get_items/armor/squid_hat
